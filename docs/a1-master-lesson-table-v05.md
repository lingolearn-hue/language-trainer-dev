...
|---|---|---|
| German (A1) | 1–19 (grammar + pronunciation; all via topic system) + 2, 11 (standalone, predate the table) | Grammar and pronunciation now authored for all 19 rows. See docs/topic-lesson-system.md |
