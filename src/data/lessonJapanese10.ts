...
export const dialogueDoctorBlock: Block = {
  ...
  content: {
    lines: [
      ...
      { id: "d3", speaker: "いしゃ", translations: { ja: "そうですか。この くすりを のんで ください。", en: "I see. Please take this medicine." } },
      { id: "d4", speaker: "かんじゃ", translations: { ja: "はい。いつ のみますか？", en: "Okay. When should I take it?" } },
      { id: "d5", speaker: "いしゃ", translations: { ja: "まいにち あさと よる、のんで ください。それから、きょうは やすんで ください。", en: "Take it every day, morning and evening. And please rest today." } },
      { id: "d6", speaker: "かんじゃ", translations: { ja: "わかりました。ありがとうございます。", en: "Understood. Thank you." } },
    ],
  },
};
...
export const dialogueFirstAidBlock: Block = {
  ...
  content: {
    lines: [
      ...
      { id: "e3", speaker: "ゆうた", translations: { ja: "ちょっと きけんかもしれません。", en: "It might be a bit dangerous (serious)." } },
      { id: "e4", speaker: "みか", translations: { ja: "まず、ここに すわって ください。それから、ばんそうこうを はって ください。", en: "First, please sit here. Then, please put on a bandage." } },
      { id: "e5", speaker: "ゆうた", translations: { ja: "はい。ありがとう。", en: "Okay. Thank you." } },
      { id: "e6", speaker: "みか", translations: { ja: "まだ いたかったら、びょういんへ いって ください。", en: "If it still hurts, please go to the hospital." } },
    ],
  },
};
