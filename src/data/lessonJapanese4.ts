...
export const vocabBlock: Block = {
  ...
  content: {
    items: [
      ...
      { id: "v17", category: "adjective", translations: { ja: "うれしい", de: "glücklich, froh", en: "happy, glad" } },
      { id: "v18", category: "adjective", translations: { ja: "かなしい", de: "traurig", en: "sad" } },
      { id: "v19", category: "adjective", translations: { ja: "さびしい", de: "einsam", en: "lonely" } },
      { id: "v20", category: "adjective", translations: { ja: "たのしい", de: "lustig, angenehm", en: "fun, enjoyable" } },
      { id: "v21", category: "adjective", translations: { ja: "こわい", de: "beängstigend, ängstlich", en: "scary, afraid" } },
      { id: "v22", category: "adjective", translations: { ja: "はずかしい", de: "peinlich berührt", en: "embarrassed" } },
      { id: "v23", category: "adjective", translations: { ja: "うらやましい", de: "neidisch", en: "envious" } },
      { id: "v24", category: "adjective", translations: { ja: "つらい", de: "schmerzhaft, schwer zu ertragen", en: "painful, hard to bear" } },
      { id: "v25", category: "adjective", translations: { ja: "ふあん", de: "ängstlich, unruhig", en: "anxious, uneasy" } },
      { id: "v26", category: "adjective", translations: { ja: "らく", de: "entspannt, bequem", en: "at ease, comfortable" } },
      { id: "v27", category: "adjective", translations: { ja: "しんぱい", de: "besorgt", en: "worried" } },
      { id: "v28", category: "adjective", translations: { ja: "げんき", de: "wohlauf, energisch", en: "well, energetic" } },
      { id: "v29", category: "adjective", translations: { ja: "たいへん", de: "hart, schwierig", en: "tough, difficult" } },
      { id: "v30", category: "adjective", translations: { ja: "だいじょうぶ", de: "okay, in Ordnung", en: "okay, fine" } },
