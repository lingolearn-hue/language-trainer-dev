...
export const PHRASES: Partial<Record<LangCode, PhraseSet>> = {
  ...
  fr: {
    ...
    introTransition:
      "D'abord, lisons mon texte ensemble. Ensuite, tu peux le relire ou utiliser tes propres mots.",
    introMonologue: [
      "Bonjour ! Je suis votre enseignant pour cette leçon.",
      "Je suis content que vous soyez ici aujourd'hui.",
      "Apprendre une langue est agréable, surtout à son propre rythme.",
      "Dans cette leçon, nous allons pratiquer du vocabulaire et de la grammaire ensemble.",
      "Nous allons aussi écouter un court dialogue et nous entraîner à le dire.",
      "Ne vous inquiétez pas des erreurs — elles font partie de l'apprentissage.",
      "Vous pouvez faire une pause à tout moment et tout répéter autant de fois que vous le souhaitez.",
      "Si cela semble trop rapide, prenez simplement un moment pour souffler.",
      "Si cela semble trop facile, nous pouvons avancer un peu plus vite.",
      "Chaque leçon s'appuie sur ce que vous avez déjà appris.",
      "À la fin, vous pourrez utiliser de nouveaux mots et expressions avec assurance.",
  ...
  es: {
    ...
    introTransition:
      "Primero, leamos mi texto juntos. Después, puedes volver a leerlo o usar tus propias palabras.",
    introMonologue: [
      "¡Hola! Soy tu profesor para esta lección.",
      "Me alegra que estés aquí hoy.",
      "Aprender un idioma es agradable, sobre todo a tu propio ritmo.",
      "En esta lección, vamos a practicar vocabulario y gramática juntos.",
      "También escucharemos un breve diálogo y practicaremos decirlo.",
      "No te preocupes por los errores — forman parte del aprendizaje.",
      "Puedes pausar en cualquier momento y repetir todo tantas veces como quieras.",
      "Si sientes que va muy rápido, tómate un momento para descansar.",
      "Si sientes que es demasiado fácil, podemos avanzar un poco más rápido.",
      "Cada lección se construye sobre lo que ya has aprendido.",
      "Al final, podrás usar palabras y expresiones nuevas con confianza.",
      "Te acompaño hasta el final.",
      "Avancemos juntos, paso a paso.",
      "¿Listo? ¡Empecemos!",
    ],
