...
export const topicRoutine: TopicLesson = {
  ...
  vocab: [
    { id: "v01", category: "noun", translations: { ja: "まいあさ", en: "every morning", de: "jeden Morgen", zh: "每天早上" } },
    { id: "v02", category: "noun", translations: { ja: "はやおき", en: "getting up early", de: "frühes Aufstehen", zh: "早起" } },
    { id: "v03", category: "verb", translations: { ja: "めざめる", en: "to wake up", de: "aufwachen", zh: "醒来" } },
    { id: "v04", category: "noun", translations: { ja: "はみがき", en: "tooth-brushing", de: "Zähneputzen", zh: "刷牙" } },
    { id: "v05", category: "verb", translations: { ja: "あらう", en: "to wash", de: "waschen", zh: "洗" } },
    { id: "v06", category: "noun", translations: { ja: "ちょうしょく", en: "breakfast", de: "Frühstück", zh: "早餐" } },
    { id: "v07", category: "noun", translations: { ja: "ゆうしょく", en: "dinner", de: "Abendessen", zh: "晚餐" } },
    { id: "v08", category: "noun", translations: { ja: "しょくじ", en: "meal", de: "Mahlzeit", zh: "用餐" } },
    { id: "v09", category: "noun", translations: { ja: "つうきん", en: "commuting to work", de: "Arbeitsweg", zh: "通勤" } },
    { id: "v10", category: "verb", translations: { ja: "でる", en: "to leave, go out", de: "hinausgehen", zh: "出门" } },
    { id: "v11", category: "verb", translations: { ja: "とる", en: "to take (a break, time)", de: "nehmen (Pause, Zeit)", zh: "休（假），花（时间）" } },
    { id: "v12", category: "noun", translations: { ja: "きゅうけい", en: "break, rest period", de: "Pause", zh: "休息时间" } },
    { id: "v13", category: "noun", translations: { ja: "すいみん", en: "sleep", de: "Schlaf", zh: "睡眠" } },
    { id: "v14", category: "noun", translations: { ja: "おふろ", en: "bath", de: "Bad", zh: "洗澡" } },
    { id: "v15", category: "noun", translations: { ja: "しゅうかん", en: "habit", de: "Gewohnheit", zh: "习惯" } },
    { id: "v16", category: "noun", translations: { ja: "かじ", en: "housework", de: "Hausarbeit", zh: "家务" } },
    { id: "v17", category: "noun", translations: { ja: "せわ", en: "care, looking after", de: "Fürsorge, Pflege", zh: "照顾" } },
    { id: "v18", category: "noun", translations: { ja: "ペット", en: "pet", de: "Haustier", zh: "宠物" } },
    { id: "v19", category: "noun", translations: { ja: "にっき", en: "diary", de: "Tagebuch", zh: "日记" } },
    { id: "v20", category: "verb", translations: { ja: "すごす", en: "to spend (time)", de: "verbringen", zh: "度过" } },
    { id: "v21", category: "noun", translations: { ja: "リズム", en: "rhythm", de: "Rhythmus", zh: "节奏" } },
    { id: "v22", category: "noun", translations: { ja: "よてい", en: "plan, schedule", de: "Vorhaben, Plan", zh: "计划，安排" } },
    { id: "v23", category: "verb", translations: { ja: "のる", en: "to ride, board", de: "einsteigen", zh: "乘坐" } },
    { id: "v24", category: "verb", translations: { ja: "おりる", en: "to get off (a vehicle)", de: "aussteigen", zh: "下车" } },
    { id: "v25", category: "verb", translations: { ja: "しゅっぱつする", en: "to depart", de: "abfahren", zh: "出发" } },
    { id: "v26", category: "verb", translations: { ja: "とうちゃくする", en: "to arrive", de: "ankommen", zh: "到达" } },
    { id: "v27", category: "verb", translations: { ja: "ふる", en: "to fall (rain, snow)", de: "fallen (Regen, Schnee)", zh: "下（雨/雪）" } },
    { id: "v28", category: "verb", translations: { ja: "けっこんする", en: "to get married", de: "heiraten", zh: "结婚" } },
    { id: "v29", category: "adverb", translations: { ja: "いつも", en: "always", de: "immer", zh: "总是" } },
    { id: "v30", category: "adverb", translations: { ja: "たいてい", en: "usually", de: "meistens", zh: "通常" } }
  ],
  dialogueA: {
    title: { ja: "にちじょうの りずむを はなす", en: "Describing Your Daily Routine", de: "Über den eigenen Tagesablauf sprechen", zh: "介绍日常生活" },
    lines: [
      { id: "d1", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "まいあさ なんじに めざめますか？", en: "What time do you wake up every morning?", de: "Um wie viel Uhr wachen Sie jeden Morgen auf?", zh: "每天早上几点醒来？" } },
      { id: "d2", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "たいてい ろくじに めざめています。はやおきです。", en: "I usually wake up at six. I'm an early riser.", de: "Ich wache meistens um sechs auf. Ich bin ein Frühaufsteher.", zh: "通常六点醒。我起得很早。" } },
      { id: "d3", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "めざめてから、なにを しますか？", en: "What do you do after waking up?", de: "Was machen Sie, nachdem Sie aufgewacht sind?", zh: "醒来之后做什么？" } },
      { id: "d4", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "はみがきを して、かおを あらって、ちょうしょくを たべています。", en: "I brush my teeth, wash my face, and eat breakfast.", de: "Ich putze mir die Zähne, wasche mein Gesicht und esse Frühstück.", zh: "刷牙、洗脸，然后吃早餐。" } },
      { id: "d5", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "そのあと、つうきんしますか？", en: "After that, do you commute to work?", de: "Danach fahren Sie zur Arbeit?", zh: "之后就去上班吗？" } },
      { id: "d6", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "はい、でんしゃに のって、かいしゃに とうちゃくします。", en: "Yes, I ride the train and arrive at the office.", de: "Ja, ich fahre mit dem Zug und komme im Büro an.", zh: "是的，坐电车到公司。" } },
      { id: "d7", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "しごとちゅうに きゅうけいは ありますか？", en: "Do you take a break during work?", de: "Machen Sie während der Arbeit eine Pause?", zh: "工作中有休息时间吗？" } },
      { id: "d8", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "はい、ひるに きゅうけいを とっています。", en: "Yes, I take a break at noon.", de: "Ja, ich mache mittags eine Pause.", zh: "有，中午会休息。" } },
      { id: "d9", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "いえに かえってから、なにを しますか？", en: "What do you do after you get home?", de: "Was machen Sie, nachdem Sie nach Hause gekommen sind?", zh: "回家之后做什么？" } },
      { id: "d10", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "おふろに はいってから、かじを します。ペットの せわも しています。", en: "I take a bath, then do housework. I also take care of my pet.", de: "Ich nehme ein Bad und mache dann Hausarbeit. Ich kümmere mich auch um mein Haustier.", zh: "先洗澡，然后做家务。也照顾宠物。" } },
      { id: "d11", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "まいにち にっきを かいていますか？", en: "Do you write in a diary every day?", de: "Schreiben Sie jeden Tag Tagebuch?", zh: "每天写日记吗？" } },
      { id: "d12", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "はい、ねるまえに かいています。", en: "Yes, I write before going to sleep.", de: "Ja, ich schreibe vor dem Schlafengehen.", zh: "对，睡前会写。" } },
      { id: "d13", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "しゅうかんが しっかり ありますね。しょくじも きちんと していますね。", en: "You really have solid habits. You handle meals properly too.", de: "Sie haben wirklich gute Gewohnheiten. Sie kümmern sich auch gut um Ihre Mahlzeiten.", zh: "习惯真的很好呢。用餐也很规律呢。" } },
      { id: "d14", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "いつも おなじ リズムで すごしています。すいみんも だいじですね。", en: "I always spend my days with the same rhythm. Sleep is important too.", de: "Ich verbringe meine Tage immer im gleichen Rhythmus. Schlaf ist auch wichtig.", zh: "我总是按照同样的节奏生活。睡眠也很重要呢。" } }
    ]
  },
  dialogueB: {
    title: { ja: "でんわで いま なにを しているか きく", en: "Asking What Someone Is Doing (by Phone)", de: "Am Telefon fragen, was jemand gerade macht", zh: "打电话问对方在做什么" },
    lines: [
      { id: "e1", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "もしもし、いま なにを していますか？", en: "Hello, what are you doing right now?", de: "Hallo, was machen Sie gerade?", zh: "喂，你现在在做什么？" } },
      { id: "e2", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "ゆうしょくを たべています。", en: "I'm eating dinner.", de: "Ich esse gerade zu Abend.", zh: "在吃晚饭。" } },
      { id: "e3", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "あ、ごめんなさい。あとで れんらくします。", en: "Oh, sorry. I'll contact you later.", de: "Oh, Entschuldigung. Ich melde mich später.", zh: "啊，抱歉。我稍后再联系你。" } },
      { id: "e4", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "だいじょうぶですよ。もう すぐ おわります。", en: "It's fine. I'll be done soon.", de: "Kein Problem. Ich bin gleich fertig.", zh: "没关系。马上就吃完了。" } },
      { id: "e5", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "そとで あめが ふっていますよ。", en: "It's raining outside, you know.", de: "Draußen regnet es übrigens.", zh: "外面正在下雨呢。" } },
      { id: "e6", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "ほんとうですか。かさを もっていきます。", en: "Really? I'll bring an umbrella.", de: "Wirklich? Ich nehme einen Regenschirm mit.", zh: "真的吗？我带伞出门吧。" } },
      { id: "e7", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "きょう なにか よていが ありますか？", en: "Do you have any plans today?", de: "Haben Sie heute etwas vor?", zh: "今天有什么安排吗？" } },
      { id: "e8", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "はい、ともだちが けっこんしているので、パーティーに いきます。", en: "Yes, my friend is married, so I'm going to a party.", de: "Ja, mein Freund ist verheiratet, also gehe ich auf eine Party.", zh: "是的，朋友结婚了，我要去参加派对。" } },
      { id: "e9", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "いいですね！なんじに しゅっぱつしますか？", en: "Nice! What time are you departing?", de: "Schön! Um wie viel Uhr fahren Sie los?", zh: "真好！几点出发？" } },
      { id: "e10", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "しちじに でます。でんしゃに のって いきます。", en: "I'll leave at seven. I'll go by train.", de: "Ich gehe um sieben. Ich fahre mit dem Zug.", zh: "七点出门。坐电车去。" } },
      { id: "e11", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "どこの えきで おりますか？", en: "Which station do you get off at?", de: "An welcher Station steigen Sie aus?", zh: "在哪个车站下车？" } },
      { id: "e12", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "ちゅうおうえきで おります。", en: "I get off at Central Station.", de: "Ich steige an der Central Station aus.", zh: "在中央站下车。" } },
      { id: "e13", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "たのしんで きてくださいね。", en: "Have a good time!", de: "Viel Spaß dabei!", zh: "祝你玩得开心！" } },
      { id: "e14", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "ありがとう。あとで れんらくしますね。", en: "Thanks. I'll contact you later.", de: "Danke. Ich melde mich später.", zh: "谢谢。我稍后联系你。" } }
    ]
  },
  grammar: {
    ja: {
      title: { ja: "〜ている：しんこうけい・しゅうかん・けっか", en: "~Teiru: Progressive, Habitual, and Resultant State", de: "~Teiru: Verlaufsform, Gewohnheit und Zustand", zh: "〜ている：进行、习惯、结果状态" },
      explanation: {
        ja: "「て-けい＋いる」には みっつの いみが あります。①いま している こと（たべています＝いま たべている）。②いつもの しゅうかん（まいあさ はしっています＝まいあさ はしる しゅうかんが ある）。③けっかの じょうたい（けっこんしています＝けっこんして、いまも その じょうたい）。ぶんみゃくで どの いみか わかります。",
      ...
      chunks: [
        { id: "g1", translations: { ja: "いま ごはんを たべています。", en: "I'm eating right now. (progressive)", de: "Ich esse gerade. (Verlaufsform)", zh: "我现在正在吃饭。（进行）" } },
        { id: "g2", translations: { ja: "まいあさ はしっています。", en: "I run every morning. (habitual)", de: "Ich laufe jeden Morgen. (Gewohnheit)", zh: "我每天早上跑步。（习惯）" } },
        { id: "g3", translations: { ja: "なにを していますか？", en: "What are you doing? (progressive question)", de: "Was machen Sie? (Frage zur Verlaufsform)", zh: "你在做什么？（进行时提问）" } },
        { id: "g4", translations: { ja: "かれは けっこんしています。", en: "He is married. (resultant state)", de: "Er ist verheiratet. (Zustand)", zh: "他已经结婚了。（结果状态）" } },
        { id: "g5", translations: { ja: "あめが ふっています。", en: "It's raining. (progressive)", de: "Es regnet. (Verlaufsform)", zh: "正在下雨。（进行）" } },
        { id: "g6", translations: { ja: "まいにち にっきを かいています。", en: "I write in a diary every day. (habitual)", de: "Ich schreibe jeden Tag Tagebuch. (Gewohnheit)", zh: "我每天写日记。（习惯）" } }
      ]
    }
  },
  grammarDrills: {
