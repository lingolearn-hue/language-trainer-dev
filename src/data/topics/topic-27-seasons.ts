...
export const topicSeasons: TopicLesson = {
  ...
  vocab: [
    { id: "v01", category: "noun", translations: { ja: "はる", en: "spring", de: "Frühling", zh: "春天" } },
    { id: "v02", category: "noun", translations: { ja: "なつ", en: "summer", de: "Sommer", zh: "夏天" } },
    { id: "v03", category: "noun", translations: { ja: "あき", en: "autumn, fall", de: "Herbst", zh: "秋天" } },
    { id: "v04", category: "noun", translations: { ja: "ふゆ", en: "winter", de: "Winter", zh: "冬天" } },
    { id: "v05", category: "noun", translations: { ja: "さくら", en: "cherry blossom", de: "Kirschblüte", zh: "樱花" } },
    { id: "v06", category: "noun", translations: { ja: "もみじ", en: "autumn leaves", de: "Herbstlaub", zh: "红叶" } },
    { id: "v07", category: "noun", translations: { ja: "ゆき", en: "snow", de: "Schnee", zh: "雪" } },
    { id: "v08", category: "noun", translations: { ja: "はなび", en: "fireworks", de: "Feuerwerk", zh: "烟花" } },
    { id: "v09", category: "noun", translations: { ja: "きせつ", en: "season", de: "Jahreszeit", zh: "季节" } },
    { id: "v10", category: "noun", translations: { ja: "きおん", en: "temperature", de: "Temperatur", zh: "气温" } },
    { id: "v11", category: "adjective", translations: { ja: "あたたかい", en: "warm", de: "warm", zh: "温暖的" } },
    { id: "v12", category: "adjective", translations: { ja: "むしあつい", en: "hot and humid", de: "schwül", zh: "闷热的" } },
    { id: "v13", category: "adjective", translations: { ja: "すずしい", en: "cool", de: "kühl", zh: "凉爽的" } },
    { id: "v14", category: "adjective", translations: { ja: "さむい", en: "cold", de: "kalt", zh: "冷的" } },
    { id: "v15", category: "adjective", translations: { ja: "すごしやすい", en: "comfortable (to live/spend time in)", de: "angenehm (zum Leben)", zh: "宜居的" } },
    { id: "v16", category: "verb", translations: { ja: "はなみをする", en: "to view cherry blossoms", de: "Kirschblüten betrachten", zh: "赏花" } },
    { id: "v17", category: "verb", translations: { ja: "およぐ", en: "to swim", de: "schwimmen", zh: "游泳" } },
    { id: "v18", category: "verb", translations: { ja: "スキーをする", en: "to ski", de: "Ski fahren", zh: "滑雪" } },
    { id: "v19", category: "verb", translations: { ja: "もみじがりをする", en: "to view autumn leaves", de: "Herbstlaub betrachten", zh: "赏红叶" } },
    { id: "v20", category: "verb", translations: { ja: "せんぷうきを つける", en: "to turn on a fan", de: "einen Ventilator anschalten", zh: "开风扇" } },
    { id: "v21", category: "verb", translations: { ja: "だんぼうを つける", en: "to turn on the heater", de: "die Heizung anschalten", zh: "开暖气" } },
    { id: "v22", category: "verb", translations: { ja: "れいぼうを つける", en: "to turn on the air conditioner", de: "die Klimaanlage anschalten", zh: "开空调" } },
    { id: "v23", category: "verb", translations: { ja: "きせつが かわる", en: "the season changes", de: "die Jahreszeit wechselt", zh: "季节变化" } },
    { id: "v24", category: "verb", translations: { ja: "かぜを ひく", en: "to catch a cold", de: "sich erkälten", zh: "感冒" } },
    { id: "v25", category: "noun", translations: { ja: "たいふう", en: "typhoon", de: "Taifun", zh: "台风" } },
    { id: "v26", category: "noun", translations: { ja: "つゆ", en: "rainy season", de: "Regenzeit", zh: "梅雨季" } },
  ...
  dialogueA: {
    ...
    lines: [
      { id: "d1", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "どの きせつが いちばん すきですか？", en: "Which season do you like the most?", de: "Welche Jahreszeit mögen Sie am meisten?", zh: "你最喜欢哪个季节？" } },
      { id: "d2", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "はるが すきです。さくらも きれいだし、あたたかいし。", en: "I like spring. The cherry blossoms are beautiful, and it's warm.", de: "Ich mag den Frühling. Die Kirschblüten sind schön, und es ist warm.", zh: "我喜欢春天。樱花漂亮，而且天气暖和。" } },
      { id: "d3", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "わたしは なつが すきです。うみで およげるし、はなびも あるし。", en: "I like summer. I can swim in the sea, and there are fireworks too.", de: "Ich mag den Sommer. Man kann im Meer schwimmen, und es gibt Feuerwerk.", zh: "我喜欢夏天。可以在海里游泳，还有烟花。" } },
      { id: "d4", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "でも なつは むしあついですよね。", en: "But summer is hot and humid, isn't it.", de: "Aber der Sommer ist schwül, oder?", zh: "不过夏天很闷热吧。" } },
      { id: "d5", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "そうですね。れいぼうを つけるし、みずも たくさん のみます。", en: "That's true. I turn on the air conditioner and drink a lot of water too.", de: "Stimmt. Ich schalte die Klimaanlage an und trinke auch viel Wasser.", zh: "是啊。会开空调，也会多喝水。" } },
      { id: "d6", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "あきは どうですか？", en: "How about autumn?", de: "Wie ist es mit dem Herbst?", zh: "秋天怎么样？" } },
      { id: "d7", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "あきは すずしいし、もみじも きれいだし、すごしやすいです。", en: "Autumn is cool, the autumn leaves are beautiful, and it's comfortable.", de: "Der Herbst ist kühl, das Herbstlaub ist schön, und es ist angenehm.", zh: "秋天凉爽，红叶也很漂亮，很宜居。" } },
      { id: "d8", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "ふゆは すきじゃないんですか？", en: "You don't like winter?", de: "Mögen Sie den Winter nicht?", zh: "你不喜欢冬天吗？" } },
      { id: "d9", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "ふゆは さむいし、かぜを ひきやすいし、あまり すきじゃないです。", en: "Winter is cold, and I easily catch colds, so I don't like it much.", de: "Der Winter ist kalt, und ich erkälte mich leicht, also mag ich ihn nicht so sehr.", zh: "冬天冷，而且容易感冒，我不太喜欢。" } },
      { id: "d10", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "でも ゆきは きれいですよ。スキーも できるし。", en: "But the snow is pretty. You can ski too.", de: "Aber der Schnee ist schön. Man kann auch Ski fahren.", zh: "不过雪很漂亮呢。也能滑雪。" } },
      { id: "d11", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "それは そうですね。だんぼうを つければ、へやは あたたかいし。", en: "That's true. If I turn on the heater, the room is warm too.", de: "Das stimmt. Wenn ich die Heizung anschalte, ist das Zimmer auch warm.", zh: "说得也是。开了暖气，房间也会暖和。" } },
      { id: "d12", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "けっきょく、どの きせつにも いいところが ありますね。", en: "In the end, every season has its good points.", de: "Letztendlich hat jede Jahreszeit ihre guten Seiten.", zh: "说到底，每个季节都有好的地方呢。" } },
      { id: "d13", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "ほんとうに そうですね。きせつが かわるのは たのしいです。", en: "Truly so. It's fun that the seasons change.", de: "Wirklich wahr. Es macht Spaß, dass sich die Jahreszeiten ändern.", zh: "真的是这样。季节变化很有意思。" } },
      { id: "d14", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "つぎの はなみ、いっしょに いきましょう！", en: "Let's go to the next cherry blossom viewing together!", de: "Lass uns beim nächsten Kirschblütenschauen zusammen hingehen!", zh: "下次一起去赏花吧！" } }
    ]
  },
  dialogueB: {
    title: { ja: "きせつごとの アクティビティを くらべる", en: "Comparing Seasonal Activities", de: "Saisonale Aktivitäten vergleichen", zh: "比较各季节的活动" },
    lines: [
      { id: "e1", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "なつと ふゆ、どちらが すきですか？", en: "Which do you like, summer or winter?", de: "Was mögen Sie mehr, Sommer oder Winter?", zh: "夏天和冬天，你更喜欢哪个？" } },
      { id: "e2", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "なつのほうが すきです。うみで およげるし、りょこうも しやすいし。", en: "I like summer more. I can swim in the sea, and it's easy to travel too.", de: "Ich mag den Sommer mehr. Man kann im Meer schwimmen, und man kann auch leicht reisen.", zh: "我更喜欢夏天。可以在海里游泳，也方便旅行。" } },
      { id: "e3", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "ふゆは アクティビティが すくないですか？", en: "Are there fewer activities in winter?", de: "Gibt es im Winter weniger Aktivitäten?", zh: "冬天的活动比较少吗？" } },
      { id: "e4", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "いいえ、スキーも できるし、おんせんも たのしめます。", en: "No, you can ski, and you can also enjoy hot springs.", de: "Nein, man kann Ski fahren, und man kann auch heiße Quellen genießen.", zh: "不，可以滑雪，还能享受温泉。" } },
      { id: "e5", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "はると あき、どちらが すごしやすいですか？", en: "Which is more comfortable, spring or autumn?", de: "Was ist angenehmer, Frühling oder Herbst?", zh: "春天和秋天，哪个更宜居？" } },
      { id: "e6", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "どちらも すごしやすいですが、あきのほうが すずしいし、たべものも おいしいです。", en: "Both are comfortable, but autumn is cooler, and the food is delicious too.", de: "Beide sind angenehm, aber der Herbst ist kühler, und das Essen ist auch lecker.", zh: "两者都很宜居，不过秋天更凉爽，食物也很好吃。" } },
      { id: "e7", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "つゆの きせつは どうですか？", en: "How about the rainy season?", de: "Wie ist die Regenzeit?", zh: "梅雨季怎么样？" } },
      ...
      { id: "e9", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "たいふうの きせつも たいへんですね。", en: "The typhoon season is also tough, isn't it.", de: "Die Taifunsaison ist auch anstrengend, oder?", zh: "台风季也很辛苦吧。" } },
      { id: "e10", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "そうですね。かぜも つよいし、でんしゃも とまることが あります。", en: "That's right. The wind is strong, and trains sometimes stop too.", de: "Stimmt. Der Wind ist stark, und manchmal fallen auch Züge aus.", zh: "是的。风很大，电车有时也会停运。" } },
      { id: "e11", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "けっきょく、どの きせつが いちばん すきですか？", en: "In the end, which season do you like the most?", de: "Letztendlich, welche Jahreszeit mögen Sie am meisten?", zh: "说到底，你最喜欢哪个季节？" } },
      { id: "e12", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "やっぱり あきが いちばん すきです。けしきも きれいだし、たべものも おいしいし。", en: "Autumn is my favorite after all. The scenery is beautiful, and the food is delicious.", de: "Der Herbst ist doch meine liebste Jahreszeit. Die Landschaft ist schön, und das Essen ist lecker.", zh: "果然还是最喜欢秋天。风景漂亮，食物也好吃。" } },
      { id: "e13", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "わたしも あきの しぜんが だいすきです。", en: "I also really love nature in autumn.", de: "Ich liebe auch die Natur im Herbst sehr.", zh: "我也非常喜欢秋天的自然风光。" } },
      { id: "e14", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "こんど いっしょに もみじがりに いきましょう。", en: "Let's go autumn-leaf viewing together next time.", de: "Lass uns das nächste Mal zusammen Herbstlaub anschauen gehen.", zh: "下次一起去赏红叶吧。" } }
    ]
  },
  grammar: {
    ja: {
      title: { ja: "〜し〜し：りゆうや とくちょうを あげる", en: "~Shi~Shi: Listing Reasons or Qualities", de: "~Shi~Shi: Gründe oder Eigenschaften aufzählen", zh: "〜し〜し：列举理由或特点" },
      explanation: {
        ja: "いくつかの りゆうや とくちょうを ならべて いうときは、ふつうけいの ぶんに「し」を つけます。「あたたかいし、さくらも きれいだし」（あたたかい こと も さくらが きれい な こと も りゆう）。さいごは「〜です／ます」で しめても いいです。ふたつ いじょうの りゆうを つよく つたえる ときに つかいます。",
      ...
      chunks: [
        { id: "g1", translations: { ja: "はるは あたたかいし、さくらも きれいです。", en: "Spring is warm, and the cherry blossoms are pretty too.", de: "Der Frühling ist warm, und die Kirschblüten sind auch schön.", zh: "春天暖和，樱花也漂亮。" } },
        { id: "g2", translations: { ja: "なつは うみで およげるし、はなびも あります。", en: "In summer you can swim in the sea, and there are fireworks too.", de: "Im Sommer kann man im Meer schwimmen, und es gibt auch Feuerwerk.", zh: "夏天可以在海里游泳，还有烟花。" } },
        { id: "g3", translations: { ja: "あきは すずしいし、たべものも おいしいです。", en: "Autumn is cool, and the food is delicious too.", de: "Der Herbst ist kühl, und das Essen ist auch lecker.", zh: "秋天凉爽，食物也好吃。" } },
        { id: "g4", translations: { ja: "ふゆは さむいし、かぜも つよいです。", en: "Winter is cold, and the wind is strong too.", de: "Der Winter ist kalt, und der Wind ist auch stark.", zh: "冬天冷，风也大。" } },
        { id: "g5", translations: { ja: "この まちは しずかだし、しぜんも ゆたかです。", en: "This town is quiet, and nature is abundant too.", de: "Diese Stadt ist ruhig, und die Natur ist auch reichhaltig.", zh: "这个小镇安静，自然也很丰富。" } },
        { id: "g6", translations: { ja: "きょうは じかんも あるし、てんきも いいから、でかけましょう。", en: "Today I have time and the weather is nice, so let's go out.", de: "Heute habe ich Zeit und das Wetter ist gut, also lass uns rausgehen.", zh: "今天有时间，天气也好，我们出去玩吧。" } }
      ]
    }
  },
  pronunciation: {
