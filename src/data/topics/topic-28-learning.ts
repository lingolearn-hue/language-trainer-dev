...
export const topicLearning: TopicLesson = {
  ...
  vocab: [
    { id: "v01", category: "noun", translations: { ja: "がくしゅう", en: "learning, study", de: "Lernen", zh: "学习" } },
    { id: "v02", category: "noun", translations: { ja: "はつおん", en: "pronunciation", de: "Aussprache", zh: "发音" } },
    { id: "v03", category: "noun", translations: { ja: "ぶんぽう", en: "grammar", de: "Grammatik", zh: "语法" } },
    { id: "v04", category: "noun", translations: { ja: "たんご", en: "vocabulary word", de: "Vokabel", zh: "单词" } },
    { id: "v05", category: "noun", translations: { ja: "かいわ", en: "conversation", de: "Konversation", zh: "会话" } },
    { id: "v06", category: "noun", translations: { ja: "しんぽ", en: "progress", de: "Fortschritt", zh: "进步" } },
    { id: "v07", category: "noun", translations: { ja: "もくひょう", en: "goal", de: "Ziel", zh: "目标" } },
    { id: "v08", category: "noun", translations: { ja: "しけん", en: "exam, test", de: "Prüfung", zh: "考试" } },
    { id: "v09", category: "noun", translations: { ja: "べんきょうほうほう", en: "study method", de: "Lernmethode", zh: "学习方法" } },
    { id: "v10", category: "noun", translations: { ja: "きょうざい", en: "study material, textbook", de: "Lernmaterial", zh: "教材" } },
    { id: "v11", category: "verb", translations: { ja: "ならう", en: "to learn (from someone)", de: "lernen (von jemandem)", zh: "学习（跟人学）" } },
    { id: "v12", category: "verb", translations: { ja: "おぼえる", en: "to memorize, remember", de: "sich merken", zh: "记住" } },
    { id: "v13", category: "verb", translations: { ja: "わすれる", en: "to forget", de: "vergessen", zh: "忘记" } },
    { id: "v14", category: "verb", translations: { ja: "じょうたつする", en: "to improve, make progress", de: "sich verbessern", zh: "进步" } },
    { id: "v15", category: "verb", translations: { ja: "なれる", en: "to get used to", de: "sich gewöhnen", zh: "习惯" } },
    { id: "v16", category: "verb", translations: { ja: "りかいする", en: "to understand", de: "verstehen", zh: "理解" } },
    { id: "v17", category: "verb", translations: { ja: "くりかえす", en: "to repeat", de: "wiederholen", zh: "重复" } },
    { id: "v18", category: "verb", translations: { ja: "ちょうせんする", en: "to challenge oneself, try", de: "sich herausfordern", zh: "挑战" } },
    { id: "v19", category: "verb", translations: { ja: "しっぱいする", en: "to fail", de: "scheitern", zh: "失败" } },
    { id: "v20", category: "verb", translations: { ja: "じしんが つく", en: "to gain confidence", de: "Selbstvertrauen gewinnen", zh: "有自信" } },
    { id: "v21", category: "adjective", translations: { ja: "むずかしい", en: "difficult", de: "schwierig", zh: "难的" } },
    { id: "v22", category: "adjective", translations: { ja: "かんたんな", en: "easy, simple", de: "einfach", zh: "简单的" } },
    { id: "v23", category: "adjective", translations: { ja: "ふくざつな", en: "complicated", de: "kompliziert", zh: "复杂的" } },
    { id: "v24", category: "noun", translations: { ja: "せんせい", en: "teacher", de: "Lehrer", zh: "老师" } },
    { id: "v25", category: "noun", translations: { ja: "がくせい", en: "student", de: "Student, Schüler", zh: "学生" } },
    { id: "v26", category: "noun", translations: { ja: "じゅぎょう", en: "class, lesson", de: "Unterricht", zh: "课程" } },
  ...
  dialogueA: {
    ...
    lines: [
      { id: "d1", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "さいきん にほんごが じょうずに なりましたね。", en: "You've gotten good at Japanese recently, haven't you.", de: "Sie sind in letzter Zeit gut im Japanischen geworden, oder?", zh: "最近日语说得越来越好了呢。" } },
      { id: "d2", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "ありがとうございます。かいわが すこし できるように なりました。", en: "Thank you. I've become able to do a bit of conversation.", de: "Danke schön. Ich bin nun in der Lage, ein wenig zu konversieren.", zh: "谢谢。已经能进行一点会话了。" } },
      { id: "d3", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "どうやって べんきょうして いますか？", en: "How have you been studying?", de: "Wie haben Sie gelernt?", zh: "是怎么学习的？" } },
      { id: "d4", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "まいにち アプリで たんごを おぼえるように しています。", en: "I'm making sure to memorize vocabulary with an app every day.", de: "Ich achte darauf, jeden Tag mit einer App Vokabeln zu lernen.", zh: "我每天都坚持用应用背单词。" } },
      { id: "d5", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "はつおんも よく なりましたね。", en: "Your pronunciation has also gotten better, hasn't it.", de: "Ihre Aussprache ist auch besser geworden, oder?", zh: "发音也变好了呢。" } },
      { id: "d6", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "はい、なんども くりかえして れんしゅうしたので、はなせるように なりました。", en: "Yes, because I practiced by repeating many times, I became able to speak.", de: "Ja, weil ich viele Male wiederholt geübt habe, konnte ich sprechen lernen.", zh: "是的，因为反复练习了很多次，所以能说了。" } },
      { id: "d7", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "さいしょは むずかしかったですか？", en: "Was it difficult at first?", de: "War es am Anfang schwierig?", zh: "一开始很难吗？" } },
      { id: "d8", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "はい、とても むずかしかったです。でも、だんだん なれてきました。", en: "Yes, it was very difficult. But I've gradually gotten used to it.", de: "Ja, es war sehr schwierig. Aber ich habe mich allmählich daran gewöhnt.", zh: "是的，一开始特别难。不过渐渐习惯了。" } },
      { id: "d9", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "ぶんぽうは どうですか？", en: "How about grammar?", de: "Wie ist es mit der Grammatik?", zh: "语法怎么样？" } },
      { id: "d10", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "むかしは ふくざつで わからなかったですが、いまは りかいできるように なりました。", en: "It used to be complicated and I didn't understand, but now I've become able to understand it.", de: "Früher war sie kompliziert und ich verstand sie nicht, aber jetzt kann ich sie verstehen.", zh: "以前很复杂不明白，现在已经能理解了。" } },
      { id: "d11", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "もくひょうは ありますか？", en: "Do you have a goal?", de: "Haben Sie ein Ziel?", zh: "有什么目标吗？" } },
      { id: "d12", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "らいねん しけんを うけたいと おもって います。", en: "I'm thinking of taking an exam next year.", de: "Ich denke daran, nächstes Jahr eine Prüfung abzulegen.", zh: "打算明年参加考试。" } },
      { id: "d13", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "どりょくして いますね。おうえんして います。", en: "You're making an effort, aren't you. I'm rooting for you.", de: "Sie geben sich Mühe, oder? Ich drücke Ihnen die Daumen.", zh: "你真努力啊。我支持你。" } },
      { id: "d14", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "ありがとうございます。これからも つづけて いきたいです。", en: "Thank you. I want to keep continuing from here on.", de: "Danke schön. Ich möchte auch weiterhin dranbleiben.", zh: "谢谢。今后也想继续坚持。" } }
    ]
  },
  dialogueB: {
    title: { ja: "あたらしい のうりょくに ついて はなす", en: "Describing a New Ability", de: "Eine neue Fähigkeit beschreiben", zh: "谈论一项新技能" },
    lines: [
      { id: "e1", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "なにか あたらしい ことを ならって いますか？", en: "Are you learning anything new?", de: "Lernen Sie gerade etwas Neues?", zh: "最近在学什么新东西吗？" } },
      { id: "e2", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "はい、さいきん かんじが よめるように なりました。", en: "Yes, recently I've become able to read kanji.", de: "Ja, kürzlich bin ich in der Lage geworden, Kanji zu lesen.", zh: "是的，最近已经能读汉字了。" } },
      { id: "e3", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "すごいですね！どうやって べんきょうしましたか？", en: "That's amazing! How did you study?", de: "Das ist toll! Wie haben Sie gelernt?", zh: "太厉害了！是怎么学的？" } },
      { id: "e4", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "まいにち すこしずつ おぼえるように しました。", en: "I made sure to memorize a little bit every day.", de: "Ich habe mir vorgenommen, jeden Tag ein bisschen zu lernen.", zh: "每天坚持记一点。" } },
      { id: "e5", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "しっぱいした ことは ありますか？", en: "Have you ever failed?", de: "Haben Sie schon einmal versagt?", zh: "有失败过吗？" } },
      { id: "e6", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "もちろん あります。でも、しっぱいから まなべるように なりました。", en: "Of course I have. But I've become able to learn from failure.", de: "Natürlich habe ich das. Aber ich habe gelernt, aus Fehlern zu lernen.", zh: "当然有过。不过已经能从失败中学习了。" } },
      { id: "e7", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "じしんが つきましたか？", en: "Have you gained confidence?", de: "Haben Sie Selbstvertrauen gewonnen?", zh: "有自信了吗？" } },
      { id: "e8", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "はい、まえより じしんが つくように なりました。", en: "Yes, I've become more confident than before.", de: "Ja, ich bin selbstbewusster geworden als zuvor.", zh: "是的，比以前更有自信了。" } },
      { id: "e9", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "きょうざいは なにを つかって いますか？", en: "What study materials are you using?", de: "Welches Lernmaterial verwenden Sie?", zh: "在用什么教材？" } },
      { id: "e10", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "アプリと ほんを りようしています。", en: "I'm using an app and books.", de: "Ich nutze eine App und Bücher.", zh: "在用应用软件和书。" } },
      { id: "e11", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "べんきょうほうほうを かえた ことは ありますか？", en: "Have you ever changed your study method?", de: "Haben Sie Ihre Lernmethode jemals geändert?", zh: "改变过学习方法吗？" } },
      { id: "e12", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "はい、いろいろ ためして みて、じぶんに あう ほうほうを みつけました。", en: "Yes, I tried various things and found a method that suits me.", de: "Ja, ich habe verschiedene Dinge ausprobiert und eine passende Methode gefunden.", zh: "是的，尝试了各种方法，找到了适合自己的。" } },
      { id: "e13", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "つぎの もくひょうは なんですか？", en: "What's your next goal?", de: "Was ist Ihr nächstes Ziel?", zh: "下一个目标是什么？" } },
      { id: "e14", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "もっと ふくざつな ぶんしょうが よめるように なりたいです。", en: "I want to become able to read more complicated writing.", de: "Ich möchte in der Lage sein, kompliziertere Texte zu lesen.", zh: "想要能读懂更复杂的文章。" } }
    ]
  },
  grammar: {
    ja: {
      title: { ja: "〜ようになる：へんかを あらわす", en: "~Youni Naru: Expressing Change Over Time", de: "~Youni Naru: Veränderung im Laufe der Zeit ausdrücken", zh: "〜ようになる：表示变化" },
      explanation: {
        ja: "いぜんは できなかった／しなかった ことが、いまは できる／する ように なった ときに つかいます。どうしの じしょけいや かのうけいに「ように なる」を つけます。「はなせる→はなせるように なる」（はなせなかったが、れんしゅうして、いまは はなせる）。じょじょな へんかを つよく つたえます。",
      ...
      chunks: [
        { id: "g1", translations: { ja: "にほんごが はなせるように なりました。", en: "I've become able to speak Japanese.", de: "Ich bin nun in der Lage, Japanisch zu sprechen.", zh: "已经能说日语了。" } },
        { id: "g2", translations: { ja: "かんじが よめるように なりました。", en: "I've become able to read kanji.", de: "Ich kann jetzt Kanji lesen.", zh: "已经能读汉字了。" } },
        { id: "g3", translations: { ja: "はやく おきるように なりました。", en: "I've come to wake up early.", de: "Ich bin dazu übergegangen, früh aufzustehen.", zh: "已经变得早起了。" } },
        { id: "g4", translations: { ja: "やさいを たべるように なりました。", en: "I've come to eat vegetables.", de: "Ich bin dazu übergegangen, Gemüse zu essen.", zh: "已经开始吃蔬菜了。" } },
        { id: "g5", translations: { ja: "ひとりで りょこうできるように なりました。", en: "I've become able to travel alone.", de: "Ich bin nun in der Lage, allein zu reisen.", zh: "已经能一个人旅行了。" } },
        { id: "g6", translations: { ja: "まえより はやく はしれるように なりました。", en: "I've become able to run faster than before.", de: "Ich kann jetzt schneller laufen als zuvor.", zh: "已经能比以前跑得更快了。" } }
      ]
    }
  },
  pronunciation: {
