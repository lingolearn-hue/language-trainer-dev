...
export const topicConjunctions: TopicLesson = {
  ...
  vocab: [
    ...
    { id: "v02", category: "noun", translations: { ja: "よてい", en: "plan", de: "Plan", zh: "计划" } },
    { id: "v03", category: "noun", translations: { ja: "りゆう", en: "reason", de: "Grund", zh: "理由" } },
    { id: "v04", category: "noun", translations: { ja: "けっか", en: "result", de: "Ergebnis", zh: "结果" } },
    { id: "v05", category: "noun", translations: { ja: "じょうきょう", en: "situation", de: "Situation", zh: "情况" } },
    { id: "v06", category: "noun", translations: { ja: "もんだい", en: "problem", de: "Problem", zh: "问题" } },
    { id: "v07", category: "noun", translations: { ja: "かいけつ", en: "solution", de: "Lösung", zh: "解决" } },
    { id: "v08", category: "noun", translations: { ja: "へんこう", en: "change", de: "Änderung", zh: "变更" } },
    { id: "v09", category: "noun", translations: { ja: "ちゅうし", en: "cancellation", de: "Absage", zh: "取消" } },
    { id: "v10", category: "noun", translations: { ja: "えんき", en: "postponement", de: "Verschiebung", zh: "延期" } },
    { id: "v11", category: "noun", translations: { ja: "じこ", en: "accident", de: "Unfall", zh: "事故" } },
    { id: "v12", category: "noun", translations: { ja: "こしょう", en: "breakdown, malfunction", de: "Störung, Defekt", zh: "故障" } },
    { id: "v13", category: "noun", translations: { ja: "しゅうり", en: "repair", de: "Reparatur", zh: "修理" } },
    { id: "v14", category: "noun", translations: { ja: "げんいん", en: "cause", de: "Ursache", zh: "原因" } },
    { id: "v15", category: "adverb", translations: { ja: "けっきょく", en: "in the end", de: "letztendlich", zh: "结果，最终" } },
    ...
    { id: "v18", category: "adverb", translations: { ja: "いがい", en: "unexpected, besides", de: "unerwartet, außer", zh: "意外，除……之外" } },
    { id: "v19", category: "adverb", translations: { ja: "どうじに", en: "at the same time", de: "gleichzeitig", zh: "同时" } },
    { id: "v20", category: "adverb", translations: { ja: "いっぽう", en: "on the other hand", de: "andererseits", zh: "另一方面" } },
    { id: "v21", category: "adverb", translations: { ja: "さらに", en: "furthermore", de: "außerdem", zh: "此外" } },
    { id: "v22", category: "adverb", translations: { ja: "ただし", en: "however, provided that", de: "jedoch, vorausgesetzt dass", zh: "但是，只是" } },
    { id: "v23", category: "adverb", translations: { ja: "もちろん", en: "of course", de: "natürlich", zh: "当然" } },
    { id: "v24", category: "adverb", translations: { ja: "たしかに", en: "certainly", de: "sicherlich", zh: "确实" } },
    { id: "v25", category: "conjunction", translations: { ja: "なぜなら", en: "because (formal)", de: "denn (formell)", zh: "因为（正式）" } },
    { id: "v26", category: "conjunction", translations: { ja: "したがって", en: "therefore (formal)", de: "daher (formell)", zh: "因此（正式）" } },
    { id: "v27", category: "conjunction", translations: { ja: "そのため", en: "for that reason", de: "aus diesem Grund", zh: "因此" } },
    { id: "v28", category: "verb", translations: { ja: "かいけつする", en: "to solve", de: "lösen", zh: "解决" } },
    { id: "v29", category: "verb", translations: { ja: "えんきする", en: "to postpone", de: "verschieben", zh: "延期" } },
    { id: "v30", category: "verb", translations: { ja: "こしょうする", en: "to break down, malfunction", de: "kaputtgehen", zh: "故障" } }
  ],
  dialogueA: {
    title: { ja: "よていの へんこうを せつめいする", en: "Explaining a Change of Plans", de: "Eine Planänderung erklären", zh: "说明计划变更" },
    lines: [
      { id: "d1", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "きょうの ハイキングは どうなりましたか？", en: "What happened to today's hike?", de: "Was ist mit der heutigen Wanderung passiert?", zh: "今天的远足怎么样了？" } },
      { id: "d2", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "たいふうが きました。だから、ちゅうしに なりました。", en: "A typhoon came. So it was canceled.", de: "Ein Taifun kam. Deshalb wurde sie abgesagt.", zh: "台风来了。所以取消了。" } },
      { id: "d3", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "ざんねんですね。てんきよほうは わるかったんですか？", en: "That's too bad. Was the weather forecast bad?", de: "Wie schade. War die Wettervorhersage schlecht?", zh: "真遗憾。天气预报不好吗？" } },
      { id: "d4", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "はい。しかし、げつようびは てんきが よく なるそうです。", en: "Yes. However, it seems the weather will get better on Monday.", de: "Ja. Allerdings soll das Wetter am Montag besser werden.", zh: "是的。不过，听说星期一天气会转好。" } },
      { id: "d5", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "じゃあ、げつようびに えんきしませんか？", en: "Then, shall we postpone it to Monday?", de: "Sollen wir sie dann auf Montag verschieben?", zh: "那要不要延期到星期一？" } },
      { id: "d6", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "いいですね。それで、みんなに れんらくしましょう。", en: "Sounds good. So let's contact everyone.", de: "Klingt gut. Also lass uns alle kontaktieren.", zh: "好啊。那我们联系大家吧。" } },
      { id: "d7", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "げつようびは しごとが あります。それに、あさは いそがしいです。", en: "I have work on Monday. Moreover, mornings are busy.", de: "Am Montag habe ich Arbeit. Außerdem sind die Vormittage stressig.", zh: "星期一我有工作。而且早上很忙。" } },
      { id: "d8", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "じゃあ、ごごから でも いいですか？", en: "Then would starting from the afternoon be okay?", de: "Wäre es dann okay, ab dem Nachmittag anzufangen?", zh: "那从下午开始可以吗？" } },
      { id: "d9", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "はい、だいじょうぶです。ばしょは かわりませんか？", en: "Yes, that's fine. Does the location stay the same?", de: "Ja, das ist in Ordnung. Bleibt der Ort gleich?", zh: "好的，没问题。地点不变吗？" } },
      { id: "d10", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "はい、かわりません。ただし、あめが ふったら また かんがえましょう。", en: "Yes, it won't change. However, if it rains, let's think again.", de: "Ja, er bleibt gleich. Falls es aber regnet, überlegen wir noch einmal.", zh: "是的，不变。不过如果下雨的话，我们再重新考虑。" } },
      { id: "d11", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "わかりました。とにかく、げつようびを たのしみに して います。", en: "Understood. Anyway, I'm looking forward to Monday.", de: "Verstanden. Jedenfalls freue ich mich auf Montag.", zh: "明白了。总之，我很期待星期一。" } },
      { id: "d12", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "わたしも です。もんだいが あったら、すぐに おしえて ください。", en: "Me too. If there's a problem, please tell me right away.", de: "Ich mich auch. Falls es ein Problem gibt, sagen Sie mir bitte sofort Bescheid.", zh: "我也是。如果有问题，请马上告诉我。" } },
      { id: "d13", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "けっきょく、いい けいけんに なりそうですね。", en: "In the end, it looks like it'll be a good experience.", de: "Letztendlich scheint es eine gute Erfahrung zu werden.", zh: "最终看起来会是一次很好的经历呢。" } },
      { id: "d14", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "そうですね。もちろん、てんきが いいことを いのりましょう。", en: "That's right. Of course, let's hope for good weather.", de: "Genau. Natürlich hoffen wir auf gutes Wetter.", zh: "是啊。当然，希望天气好。" } }
    ]
  },
  dialogueB: {
    title: { ja: "りゆうと ついかの じょうほうを つたえる", en: "Giving Reasons and Additional Information", de: "Gründe und zusätzliche Informationen geben", zh: "说明理由和补充信息" },
    lines: [
      { id: "e1", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "でんしゃが とまって いますね。げんいんは なんですか？", en: "The trains have stopped. What's the cause?", de: "Die Züge stehen still. Was ist die Ursache?", zh: "电车停运了呢。原因是什么？" } },
      { id: "e2", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "じこが あったそうです。したがって、しばらく うごかないと おもいます。", en: "It seems there was an accident. Therefore, I think it won't move for a while.", de: "Es soll einen Unfall gegeben haben. Daher glaube ich, dass sie eine Weile stillstehen.", zh: "听说发生了事故。因此，我觉得暂时不会开动。" } },
      { id: "e3", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "こまりましたね。なぜなら、かいぎに ちこくしてしまいます。", en: "That's a problem. Because I'll end up being late for the meeting.", de: "Das ist ein Problem, denn ich werde zu spät zur Besprechung kommen.", zh: "真麻烦。因为我会赶不上会议了。" } },
      { id: "e4", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "そのため、バスに のった ほうが いいかもしれません。", en: "For that reason, it might be better to take the bus.", de: "Aus diesem Grund wäre es vielleicht besser, den Bus zu nehmen.", zh: "因此，也许坐公交车会更好。" } },
      { id: "e5", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "たしかに、それは いい かんがえですね。", en: "Certainly, that's a good idea.", de: "Sicherlich ist das eine gute Idee.", zh: "确实，那是个好主意。" } },
      { id: "e6", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "いっぽう、バスも こんで いるかもしれません。", en: "On the other hand, the bus might also be crowded.", de: "Andererseits könnte der Bus auch überfüllt sein.", zh: "另一方面，公交车可能也很挤。" } },
      { id: "e7", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "さらに、じかんも かかりそうです。", en: "Furthermore, it'll probably take more time too.", de: "Außerdem wird es wahrscheinlich auch länger dauern.", zh: "而且，好像也会更花时间。" } },
      { id: "e8", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "つまり、どちらを えらんでも もんだいが あるんですね。", en: "In other words, whichever we choose, there's a problem.", de: "Das heißt, egal welche wir wählen, es gibt ein Problem.", zh: "也就是说，不管选哪个都有问题呢。" } },
      { id: "e9", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "じょうきょうを かいしゃに でんわで つたえましょう。", en: "Let's tell the company the situation by phone.", de: "Lass uns der Firma die Situation telefonisch mitteilen.", zh: "打电话把情况告诉公司吧。" } },
      { id: "e10", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "いがい、しゃちょうは りかいして くれると おもいます。", en: "Unexpectedly, I think the president will understand.", de: "Überraschenderweise glaube ich, dass der Chef Verständnis haben wird.", zh: "意外的是，我觉得老板会理解的。" } },
      { id: "e11", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "でんしゃの こしょうは よく ある もんだいですからね。", en: "Train malfunctions are a common problem, after all.", de: "Zugstörungen sind schließlich ein häufiges Problem.", zh: "电车故障本来就是常见的问题嘛。" } },
      { id: "e12", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "どうじに、しゅうりも はじまって いるみたいです。", en: "At the same time, it seems repairs have also started.", de: "Gleichzeitig scheinen auch die Reparaturen begonnen zu haben.", zh: "同时，好像也开始修理了。" } },
      { id: "e13", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "けっか、あんしんしました。", en: "As a result, I feel relieved.", de: "Im Ergebnis bin ich erleichtert.", zh: "结果，我放心了。" } },
      { id: "e14", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "ただし、もう すこし じかんが かかるかもしれませんね。", en: "However, it might still take a bit more time.", de: "Es könnte jedoch noch etwas länger dauern.", zh: "不过，可能还需要再花点时间。" } }
    ]
  },
  grammar: {
    ja: {
      title: { ja: "しかし／だから／それで／それに：ぶんを つなぐ せつぞくし", en: "Shikashi / Dakara / Sorede / Sore Ni: Connecting Sentences", de: "Shikashi / Dakara / Sorede / Sore Ni: Sätze verbinden", zh: "しかし／だから／それで／それに：连接句子" },
      explanation: {
        ja: "これらの せつぞくしは、ぶんの さいしょに おいて、まえの ぶんと つぎの ぶんを つなぎます。〜たら や〜ので のように ひとつの ぶんの なかを つなぐのでは なく、ふたつの かんぜんな ぶんを つなぎます。「しかし」は ぎゃくせつ（フォーマル）、「だから」は げんいん・けっか（カジュアルから ちゅうりつ）、「それで」は はなしの ながれの けいぞく、「それに」は つけくわえを あらわします。",
      ...
      chunks: [
        { id: "g1", translations: { ja: "あめが ふりました。しかし、しあいは ちゅうしに なりませんでした。", en: "It rained. However, the match wasn't canceled.", de: "Es regnete. Das Spiel wurde jedoch nicht abgesagt.", zh: "下雨了。但是比赛没有取消。" } },
        { id: "g2", translations: { ja: "でんしゃが おくれました。だから、ちこくしました。", en: "The train was late. So I was late.", de: "Der Zug hatte Verspätung. Deshalb kam ich zu spät.", zh: "电车晚点了。所以我迟到了。" } },
        { id: "g3", translations: { ja: "しごとが おわりました。それで、いえに かえりました。", en: "Work ended. And so I went home.", de: "Die Arbeit war zu Ende. Also ging ich nach Hause.", zh: "工作结束了。于是我回家了。" } },
        { id: "g4", translations: { ja: "この レストランは やすいです。それに、おいしいです。", en: "This restaurant is cheap. Moreover, it's delicious.", de: "Dieses Restaurant ist billig. Außerdem ist es lecker.", zh: "这家餐厅便宜。而且很好吃。" } },
        { id: "g5", translations: { ja: "たいふうが きました。それで、でんしゃが とまりました。", en: "A typhoon came. So the trains stopped.", de: "Ein Taifun kam. Deshalb hielten die Züge an.", zh: "台风来了。所以电车停了。" } },
        { id: "g6", translations: { ja: "かれは わかいです。しかし、とても けいけんが あります。", en: "He is young. However, he has a lot of experience.", de: "Er ist jung. Er hat jedoch viel Erfahrung.", zh: "他很年轻。但是很有经验。" } }
      ]
    }
  },
  pronunciation: {
