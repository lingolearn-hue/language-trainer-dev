...
export const topicWeekend: TopicLesson = {
  ...
  vocab: [
    { id: "v01", category: "noun", translations: { ja: "しゅうまつ", jaKanji: "週末", en: "weekend", de: "Wochenende", zh: "周末" } },
    { id: "v02", category: "noun", translations: { ja: "どようび", jaKanji: "土曜日", en: "Saturday", de: "Samstag", zh: "星期六" } },
    { id: "v03", category: "noun", translations: { ja: "にちようび", jaKanji: "日曜日", en: "Sunday", de: "Sonntag", zh: "星期日" } },
    { id: "v04", category: "noun", translations: { ja: "やすみ", jaKanji: "休み", en: "day off", de: "freier Tag", zh: "休息日" } },
    { id: "v05", category: "noun", translations: { ja: "えいが", jaKanji: "映画", en: "movie", de: "Film", zh: "电影" } },
    { id: "v06", category: "noun", translations: { ja: "かいもの", jaKanji: "買い物", en: "shopping", de: "Einkaufen", zh: "购物" } },
    { id: "v07", category: "noun", translations: { ja: "りょこう", jaKanji: "旅行", en: "trip", de: "Reise", zh: "旅行" } },
    { id: "v08", category: "noun", translations: { ja: "そうじ", jaKanji: "掃除", en: "cleaning", de: "Putzen", zh: "打扫" } },
    { id: "v09", category: "noun", translations: { ja: "せんたく", jaKanji: "洗濯", en: "laundry", de: "Wäsche", zh: "洗衣服" } },
    { id: "v10", category: "noun", translations: { ja: "りょうり", jaKanji: "料理", en: "cooking", de: "Kochen", zh: "做饭" } },
    { id: "v11", category: "noun", translations: { ja: "どくしょ", jaKanji: "読書", en: "reading", de: "Lesen", zh: "读书" } },
    { id: "v12", category: "noun", translations: { ja: "さんぽ", jaKanji: "散歩", en: "walk, stroll", de: "Spaziergang", zh: "散步" } },
    ...
    { id: "v15", category: "noun", translations: { ja: "びじゅつかん", jaKanji: "美術館", en: "art museum", de: "Kunstmuseum", zh: "美术馆" } },
    { id: "v16", category: "noun", translations: { ja: "はくぶつかん", jaKanji: "博物館", en: "museum", de: "Museum", zh: "博物馆" } },
    { id: "v17", category: "noun", translations: { ja: "こうえん", jaKanji: "公園", en: "park", de: "Park", zh: "公园" } },
    ...
    { id: "v20", category: "verb", translations: { ja: "やすむ", jaKanji: "休む", en: "to rest", de: "sich ausruhen", zh: "休息" } },
    { id: "v21", category: "verb", translations: { ja: "あそぶ", jaKanji: "遊ぶ", en: "to play, hang out", de: "spielen, sich treffen", zh: "玩" } },
    { id: "v22", category: "verb", translations: { ja: "でかける", jaKanji: "出かける", en: "to go out", de: "ausgehen", zh: "外出" } },
    { id: "v23", category: "verb", translations: { ja: "かえる", jaKanji: "帰る", en: "to return home", de: "nach Hause gehen", zh: "回家" } },
    { id: "v24", category: "verb", translations: { ja: "ねる", jaKanji: "寝る", en: "to sleep", de: "schlafen", zh: "睡觉" } },
    { id: "v25", category: "verb", translations: { ja: "おきる", jaKanji: "起きる", en: "to wake up", de: "aufwachen", zh: "起床" } },
    { id: "v26", category: "verb", translations: { ja: "のんびりする", en: "to relax, take it easy", de: "entspannen", zh: "放松" } },
    { id: "v27", category: "adjective", translations: { ja: "たのしい", jaKanji: "楽しい", en: "fun, enjoyable", de: "unterhaltsam, lustig", zh: "开心的" } },
    { id: "v28", category: "adjective", translations: { ja: "いそがしい", jaKanji: "忙しい", en: "busy", de: "beschäftigt", zh: "忙碌的" } },
    { id: "v29", category: "verb", translations: { ja: "つかれる", jaKanji: "疲れる", en: "to get tired", de: "müde werden", zh: "累" } },
    { id: "v30", category: "adjective", translations: { ja: "しずかな", jaKanji: "静かな", en: "quiet", de: "ruhig", zh: "安静的" } },
    { id: "v31", category: "adverb", translations: { ja: "いつも", en: "always", de: "immer", zh: "总是" } },
    { id: "v32", category: "adverb", translations: { ja: "たまに", en: "occasionally", de: "gelegentlich", zh: "偶尔" } }
  ],
  dialogueA: {
    title: { ja: "ともだちと しゅうまつの はなし", jaKanji: "友達と週末の話", en: "Talking About the Weekend with a Friend (Casual)", de: "Über das Wochenende mit einem Freund sprechen (informell)", zh: "和朋友聊周末（口语）" },
    lines: [
      { id: "d1", speaker: { ja: "ゆき", en: "Yuki", de: "Yuki", zh: "雪" }, translations: { ja: "しゅうまつ なにを した？", jaKanji: "週末何をした？", en: "What did you do this weekend?", de: "Was hast du am Wochenende gemacht?", zh: "周末做什么了？" } },
      { id: "d2", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "えいがを みた。すごく たのしかった。", jaKanji: "映画を見た。すごく楽しかった。", en: "I watched a movie. It was really fun.", de: "Ich habe einen Film gesehen. Es hat richtig Spaß gemacht.", zh: "看电影了。特别有意思。" } },
      { id: "d3", speaker: { ja: "ゆき", en: "Yuki", de: "Yuki", zh: "雪" }, translations: { ja: "いいね！どこで みたの？", jaKanji: "いいね！どこで見たの？", en: "Nice! Where did you watch it?", de: "Schön! Wo hast du ihn gesehen?", zh: "真好！在哪里看的？" } },
      { id: "d4", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "うちで みた。ゆきは？", jaKanji: "家で見た。ゆきは？", en: "I watched it at home. What about you?", de: "Ich habe ihn zu Hause gesehen. Und du?", zh: "在家看的。你呢？" } },
      { id: "d5", speaker: { ja: "ゆき", en: "Yuki", de: "Yuki", zh: "雪" }, translations: { ja: "わたしは こうえんを さんぽした。とても しずかだった。", jaKanji: "私は公園を散歩した。とても静かだった。", en: "I took a walk in the park. It was very quiet.", de: "Ich bin im Park spazieren gegangen. Es war sehr ruhig.", zh: "我在公园散步了。特别安静。" } },
      { id: "d6", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "そうじも した？", jaKanji: "掃除もした？", en: "Did you also clean?", de: "Hast du auch geputzt?", zh: "也打扫了吗？" } },
      { id: "d7", speaker: { ja: "ゆき", en: "Yuki", de: "Yuki", zh: "雪" }, translations: { ja: "うん、そうじと せんたくを した。ちょっと つかれた。", jaKanji: "うん、掃除と洗濯をした。ちょっと疲れた。", en: "Yeah, I cleaned and did laundry. I got a bit tired.", de: "Ja, ich habe geputzt und Wäsche gewaschen. Ich wurde etwas müde.", zh: "嗯，打扫了还洗了衣服。有点累了。" } },
      { id: "d8", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "パーティーには いかなかったの？", jaKanji: "パーティーには行かなかったの？", en: "Didn't you go to the party?", de: "Bist du nicht zur Party gegangen?", zh: "没去派对吗？" } },
      { id: "d9", speaker: { ja: "ゆき", en: "Yuki", de: "Yuki", zh: "雪" }, translations: { ja: "いかなかった。いそがしかったから。", jaKanji: "行かなかった。忙しかったから。", en: "I didn't go. Because I was busy.", de: "Ich bin nicht gegangen. Weil ich beschäftigt war.", zh: "没去。因为很忙。" } },
      { id: "d10", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "そっか。でんわぐらい できたでしょ。", jaKanji: "そっか。電話ぐらいできたでしょ。", en: "I see. You could've at least called though.", de: "Verstehe. Du hättest wenigstens anrufen können.", zh: "这样啊。至少能打个电话吧。" } },
      { id: "d11", speaker: { ja: "ゆき", en: "Yuki", de: "Yuki", zh: "雪" }, translations: { ja: "ごめん、はやく ねちゃったんだ。", jaKanji: "ごめん、早く寝ちゃったんだ。", en: "Sorry, I went to sleep early.", de: "Sorry, ich bin früh eingeschlafen.", zh: "对不起，我早早就睡了。" } },
      { id: "d12", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "なんじに おきたの？", jaKanji: "何時に起きたの？", en: "What time did you wake up?", de: "Um wie viel Uhr bist du aufgewacht?", zh: "几点起的床？" } },
      { id: "d13", speaker: { ja: "ゆき", en: "Yuki", de: "Yuki", zh: "雪" }, translations: { ja: "くじに おきて、のんびりした。", jaKanji: "9時に起きて、のんびりした。", en: "I woke up at nine and relaxed.", de: "Ich bin um neun aufgewacht und habe entspannt.", zh: "九点起床，然后放松了一下。" } },
      { id: "d14", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "いい しゅうまつだったね！", jaKanji: "いい週末だったね！", en: "Sounds like a nice weekend!", de: "Klingt nach einem schönen Wochenende!", zh: "真是个不错的周末啊！" } }
    ]
  },
  dialogueB: {
    title: { ja: "どうりょうと しゅうまつの はなし", jaKanji: "同僚と週末の話", en: "Talking About the Weekend with a Coworker (Polite)", de: "Über das Wochenende mit einem Kollegen sprechen (höflich)", zh: "和同事聊周末（礼貌）" },
    lines: [
      { id: "e1", speaker: { ja: "たなかさん", en: "Mr. Tanaka", de: "Herr Tanaka", zh: "田中先生" }, translations: { ja: "しゅうまつは なにを しましたか？", jaKanji: "週末は何をしましたか？", en: "What did you do this weekend?", de: "Was haben Sie am Wochenende gemacht?", zh: "周末做什么了？" } },
      { id: "e2", speaker: { ja: "やまださん", en: "Ms. Yamada", de: "Frau Yamada", zh: "山田女士" }, translations: { ja: "かぞくと りょこうを しました。とても たのしかったです。", jaKanji: "家族と旅行をしました。とても楽しかったです。", en: "I went on a trip with my family. It was very fun.", de: "Ich bin mit meiner Familie verreist. Es hat sehr viel Spaß gemacht.", zh: "和家人一起旅行了。非常开心。" } },
      { id: "e3", speaker: { ja: "たなかさん", en: "Mr. Tanaka", de: "Herr Tanaka", zh: "田中先生" }, translations: { ja: "どこに いきましたか？", jaKanji: "どこに行きましたか？", en: "Where did you go?", de: "Wo sind Sie hingefahren?", zh: "去哪里了？" } },
      { id: "e4", speaker: { ja: "やまださん", en: "Ms. Yamada", de: "Frau Yamada", zh: "山田女士" }, translations: { ja: "はくぶつかんと びじゅつかんに いきました。", jaKanji: "博物館と美術館に行きました。", en: "We went to a museum and an art museum.", de: "Wir waren in einem Museum und einem Kunstmuseum.", zh: "去了博物馆和美术馆。" } },
      { id: "e5", speaker: { ja: "たなかさん", en: "Mr. Tanaka", de: "Herr Tanaka", zh: "田中先生" }, translations: { ja: "それは よかったですね。てんきは どうでしたか？", jaKanji: "それはよかったですね。天気はどうでしたか？", en: "That's great. How was the weather?", de: "Das ist schön. Wie war das Wetter?", zh: "那太好了。天气怎么样？" } },
      { id: "e6", speaker: { ja: "やまださん", en: "Ms. Yamada", de: "Frau Yamada", zh: "山田女士" }, translations: { ja: "とても いい てんきでした。あかるくて しずかでした。", jaKanji: "とてもいい天気でした。明るくて静かでした。", en: "The weather was very nice. It was bright and quiet.", de: "Das Wetter war sehr schön. Es war hell und ruhig.", zh: "天气非常好。明亮又安静。" } },
      { id: "e7", speaker: { ja: "たなかさん", en: "Mr. Tanaka", de: "Herr Tanaka", zh: "田中先生" }, translations: { ja: "たなかさんは しゅうまつ なにを しましたか？", jaKanji: "田中さんは週末何をしましたか？", en: "What did you do this weekend, Mr. Tanaka?", de: "Und was haben Sie am Wochenende gemacht, Herr Tanaka?", zh: "田中先生周末做了什么？" } },
      { id: "e8", speaker: { ja: "たなかさん", en: "Mr. Tanaka", de: "Herr Tanaka", zh: "田中先生" }, translations: { ja: "わたしは うちで そうじと りょうりを しました。", jaKanji: "私は家で掃除と料理をしました。", en: "I cleaned and cooked at home.", de: "Ich habe zu Hause geputzt und gekocht.", zh: "我在家打扫和做饭了。" } },
      { id: "e9", speaker: { ja: "やまださん", en: "Ms. Yamada", de: "Frau Yamada", zh: "山田女士" }, translations: { ja: "どんな りょうりを つくりましたか？", jaKanji: "どんな料理を作りましたか？", en: "What kind of food did you cook?", de: "Was für ein Gericht haben Sie gekocht?", zh: "做了什么菜？" } },
      { id: "e10", speaker: { ja: "たなかさん", en: "Mr. Tanaka", de: "Herr Tanaka", zh: "田中先生" }, translations: { ja: "にほんりょうりを つくりました。すこし むずかしかったです。", jaKanji: "日本料理を作りました。少し難しかったです。", en: "I made Japanese food. It was a bit difficult.", de: "Ich habe japanisches Essen gekocht. Es war etwas schwierig.", zh: "做了日本料理。有点难。" } },
      { id: "e11", speaker: { ja: "やまださん", en: "Ms. Yamada", de: "Frau Yamada", zh: "山田女士" }, translations: { ja: "げつようびは いそがしいですか？", jaKanji: "月曜日は忙しいですか？", en: "Are you busy on Monday?", de: "Sind Sie am Montag beschäftigt?", zh: "星期一忙吗？" } },
      { id: "e12", speaker: { ja: "たなかさん", en: "Mr. Tanaka", de: "Herr Tanaka", zh: "田中先生" }, translations: { ja: "はい、すこし いそがしいです。かいぎが あります。", jaKanji: "はい、少し忙しいです。会議があります。", en: "Yes, a bit busy. I have a meeting.", de: "Ja, etwas beschäftigt. Ich habe eine Besprechung.", zh: "是的，有点忙。有个会议。" } },
      { id: "e13", speaker: { ja: "やまださん", en: "Ms. Yamada", de: "Frau Yamada", zh: "山田女士" }, translations: { ja: "そうですか。がんばってくださいね。", jaKanji: "そうですか。頑張ってくださいね。", en: "I see. Good luck with it.", de: "Verstehe. Viel Erfolg dabei.", zh: "这样啊。加油哦。" } },
      { id: "e14", speaker: { ja: "たなかさん", en: "Mr. Tanaka", de: "Herr Tanaka", zh: "田中先生" }, translations: { ja: "ありがとうございます。よい いっしゅうかんを！", jaKanji: "ありがとうございます。良い一週間を！", en: "Thank you. Have a good week!", de: "Danke schön. Eine gute Woche!", zh: "谢谢。祝你一周愉快！" } }
    ]
  },
  grammar: {
    ja: {
      title: { ja: "かこけい：ふつうけい と ていねいけい", jaKanji: "過去形：普通形と丁寧形", en: "Past Tense: Plain vs Polite Form", de: "Vergangenheit: Plain-Form und höfliche Form", zh: "过去时：简体与敬体" },
      explanation: {
        ja: "にほんごの かこけいには ふたつの スタイルが あります。ていねいけい（ました、〜かったです、〜でした）は しごとや しらない ひとに つかいます。ふつうけい（た、〜かった、〜だった）は かぞくや ともだちに つかいます。どちらも いみは おなじで、つかう ばめんが ちがいます。", jaKanji: "日本語の過去形には二つのスタイルがあります。丁寧形（ました、〜かったです、〜でした）は仕事や知らない人に使います。普通形（た、〜かった、〜だった）は家族や友達に使います。どちらも意味は同じで、使う場面が違います。",
      ...
      chunks: [
        { id: "g1", translations: { ja: "えいがを みました。", jaKanji: "映画を見ました。", en: "I watched a movie. (polite)", de: "Ich habe einen Film gesehen. (höflich)", zh: "看电影了。（敬体）" } },
        { id: "g2", translations: { ja: "えいがを みた。", jaKanji: "映画を見た。", en: "I watched a movie. (plain, casual)", de: "Ich habe einen Film gesehen. (Plain-Form, informell)", zh: "看电影了。（简体，口语）" } },
        { id: "g3", translations: { ja: "たのしかったです。", jaKanji: "楽しかったです。", en: "It was fun. (polite)", de: "Es hat Spaß gemacht. (höflich)", zh: "很开心。（敬体）" } },
        { id: "g4", translations: { ja: "たのしかった。", jaKanji: "楽しかった。", en: "It was fun. (plain, casual)", de: "Es hat Spaß gemacht. (Plain-Form, informell)", zh: "很开心。（简体，口语）" } },
        { id: "g5", translations: { ja: "しずかでした。", jaKanji: "静かでした。", en: "It was quiet. (polite)", de: "Es war ruhig. (höflich)", zh: "很安静。（敬体）" } },
        { id: "g6", translations: { ja: "しずかだった。", jaKanji: "静かだった。", en: "It was quiet. (plain, casual)", de: "Es war ruhig. (Plain-Form, informell)", zh: "很安静。（简体，口语）" } }
      ]
    }
  },
  grammarDrills: {
