...
export const topicTransport: TopicLesson = {
  ...
  vocab: [
    ...
    { id: "v02", category: "noun", translations: { ja: "きっぷ", jaKanji: "切符", en: "ticket", de: "Fahrkarte", zh: "车票" } },
    { id: "v03", category: "noun", translations: { ja: "こうくうけん", jaKanji: "航空券", en: "airline ticket", de: "Flugticket", zh: "机票" } },
    { id: "v04", category: "noun", translations: { ja: "くうこう", jaKanji: "空港", en: "airport", de: "Flughafen", zh: "机场" } },
    { id: "v05", category: "noun", translations: { ja: "えき", jaKanji: "駅", en: "station", de: "Bahnhof", zh: "车站" } },
    { id: "v06", category: "noun", translations: { ja: "ホーム", en: "platform", de: "Bahnsteig", zh: "站台" } },
    { id: "v07", category: "noun", translations: { ja: "にもつ", jaKanji: "荷物", en: "luggage", de: "Gepäck", zh: "行李" } },
    ...
    { id: "v12", category: "noun", translations: { ja: "のりかえ", jaKanji: "乗り換え", en: "transfer, connection", de: "Umsteigen", zh: "换乘" } },
    { id: "v13", category: "noun", translations: { ja: "しゅっぱつ", jaKanji: "出発", en: "departure", de: "Abfahrt, Abflug", zh: "出发" } },
    { id: "v14", category: "noun", translations: { ja: "とうちゃく", jaKanji: "到着", en: "arrival", de: "Ankunft", zh: "到达" } },
    { id: "v15", category: "noun", translations: { ja: "ちこく", jaKanji: "遅刻", en: "being late", de: "Verspätung", zh: "迟到" } },
    { id: "v16", category: "verb", translations: { ja: "まにあう", jaKanji: "間に合う", en: "to be in time", de: "rechtzeitig kommen", zh: "赶得上" } },
    { id: "v17", category: "verb", translations: { ja: "まつ", jaKanji: "待つ", en: "to wait", de: "warten", zh: "等待" } },
    { id: "v18", category: "verb", translations: { ja: "いそぐ", jaKanji: "急ぐ", en: "to hurry", de: "sich beeilen", zh: "赶紧" } },
    { id: "v19", category: "verb", translations: { ja: "のる", jaKanji: "乗る", en: "to board, ride", de: "einsteigen", zh: "乘坐" } },
    { id: "v20", category: "verb", translations: { ja: "おりる", jaKanji: "降りる", en: "to get off", de: "aussteigen", zh: "下车" } },
    { id: "v21", category: "verb", translations: { ja: "じゅんびする", jaKanji: "準備する", en: "to prepare", de: "vorbereiten", zh: "准备" } },
    { id: "v22", category: "verb", translations: { ja: "つめる", jaKanji: "詰める", en: "to pack", de: "packen", zh: "装" } },
    { id: "v23", category: "verb", translations: { ja: "わすれる", jaKanji: "忘れる", en: "to forget", de: "vergessen", zh: "忘记" } },
    { id: "v24", category: "verb", translations: { ja: "かくにんする", jaKanji: "確認する", en: "to confirm", de: "bestätigen", zh: "确认" } },
    { id: "v25", category: "verb", translations: { ja: "よやくする", jaKanji: "予約する", en: "to reserve", de: "reservieren", zh: "预订" } },
    { id: "v26", category: "noun", translations: { ja: "まどがわのせき", jaKanji: "窓側の席", en: "window seat", de: "Fensterplatz", zh: "靠窗座位" } },
    { id: "v27", category: "noun", translations: { ja: "つうろがわのせき", jaKanji: "通路側の席", en: "aisle seat", de: "Gangplatz", zh: "靠走廊座位" } },
    { id: "v28", category: "noun", translations: { ja: "あんぜんベルト", jaKanji: "安全ベルト", en: "seat belt", de: "Sicherheitsgurt", zh: "安全带" } },
    { id: "v29", category: "noun", translations: { ja: "りょこう", jaKanji: "旅行", en: "trip, travel", de: "Reise", zh: "旅行" } },
    { id: "v30", category: "noun", translations: { ja: "よてい", jaKanji: "予定", en: "plan, itinerary", de: "Plan", zh: "计划" } },
    { id: "v31", category: "adverb", translations: { ja: "とつぜん", jaKanji: "突然", en: "suddenly", de: "plötzlich", zh: "突然" } },
    { id: "v32", category: "adverb", translations: { ja: "やっと", en: "finally", de: "endlich", zh: "终于" } }
  ],
  dialogueA: {
    title: { ja: "りょこうの じゅんびを する", jaKanji: "旅行の準備をする", en: "Getting Ready for a Trip", de: "Sich auf eine Reise vorbereiten", zh: "准备旅行" },
    lines: [
      { id: "d1", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "にもつは もう つめましたか？", jaKanji: "荷物はもう詰めましたか？", en: "Have you packed your luggage yet?", de: "Haben Sie Ihr Gepäck schon gepackt?", zh: "行李已经收拾好了吗？" } },
      { id: "d2", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "パスポートを かくにんしてから、つめます。", jaKanji: "パスポートを確認してから、詰めます。", en: "I'll pack after I confirm my passport.", de: "Ich packe, nachdem ich meinen Reisepass bestätigt habe.", zh: "确认好护照之后再收拾。" } },
      { id: "d3", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "こうくうけんは よやくしましたか？", jaKanji: "航空券は予約しましたか？", en: "Did you reserve the airline ticket?", de: "Haben Sie das Flugticket reserviert?", zh: "机票预订了吗？" } },
      { id: "d4", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "はい、しゅっぱつの じかんを かくにんしてから、よやくしました。", jaKanji: "はい、出発の時間を確認してから、予約しました。", en: "Yes, I reserved it after confirming the departure time.", de: "Ja, ich habe reserviert, nachdem ich die Abfahrtszeit bestätigt hatte.", zh: "是的，确认出发时间之后就预订了。" } },
      { id: "d5", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "せきは まどがわですか？", jaKanji: "席は窓側ですか？", en: "Is your seat a window seat?", de: "Ist Ihr Platz ein Fensterplatz?", zh: "座位是靠窗的吗？" } },
      { id: "d6", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "いいえ、つうろがわの せきを えらびました。", jaKanji: "いいえ、通路側の席を選びました。", en: "No, I chose an aisle seat.", de: "Nein, ich habe einen Gangplatz gewählt.", zh: "不，我选了靠走廊的座位。" } },
      { id: "d7", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "くうこうまで どうやって いきますか？", jaKanji: "空港までどうやって行きますか？", en: "How are you getting to the airport?", de: "Wie kommen Sie zum Flughafen?", zh: "怎么去机场？" } },
      { id: "d8", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "でんしゃに のってから、バスに のりかえます。", jaKanji: "電車に乗ってから、バスに乗り換えます。", en: "After riding the train, I'll transfer to a bus.", de: "Nachdem ich den Zug genommen habe, steige ich in einen Bus um.", zh: "坐了电车之后，再换乘公交车。" } },
      { id: "d9", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "ちこくしないように、はやく でたほうが いいですよ。", jaKanji: "遅刻しないように、早く出たほうがいいですよ。", en: "You'd better leave early so you're not late.", de: "Sie sollten früh losgehen, damit Sie nicht zu spät kommen.", zh: "为了不迟到，最好早点出发。" } },
      { id: "d10", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "そうですね。じゅんびが おわったあとで、すぐ でます。", jaKanji: "そうですね。準備が終わったあとで、すぐ出ます。", en: "You're right. I'll leave right after I finish preparing.", de: "Sie haben recht. Ich gehe gleich los, nachdem ich fertig bin.", zh: "说得对。准备好之后马上出发。" } },
      { id: "d11", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "セキュリティチェックは じかんが かかりますね。", jaKanji: "セキュリティチェックは時間がかかりますね。", en: "The security check takes time, doesn't it.", de: "Die Sicherheitskontrolle dauert lange, oder?", zh: "安检很花时间呢。" } },
      { id: "d12", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "はい、だから チェックインを してから、はやめに いきます。", jaKanji: "はい、だからチェックインをしてから、早めに行きます。", en: "Yes, so after checking in, I'll go there early.", de: "Ja, deshalb gehe ich nach dem Check-in früh dorthin.", zh: "是的，所以办完登机手续之后会早点过去。" } },
      { id: "d13", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "あんぜんベルトを わすれないで くださいね。", jaKanji: "安全ベルトを忘れないでくださいね。", en: "Please don't forget your seat belt.", de: "Vergessen Sie bitte nicht den Sicherheitsgurt.", zh: "请不要忘记系安全带。" } },
      { id: "d14", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "だいじょうぶです。よい りょこうに なりそうです。", jaKanji: "大丈夫です。良い旅行になりそうです。", en: "It's fine. It looks like it'll be a good trip.", de: "Alles gut. Es scheint eine schöne Reise zu werden.", zh: "没问题。看起来会是一次不错的旅行。" } }
    ]
  },
  dialogueB: {
    title: { ja: "りょこうの じゅんばんを せつめいする", jaKanji: "旅行の順番を説明する", en: "Explaining the Order of a Journey", de: "Den Ablauf einer Reise erklären", zh: "说明旅行的顺序" },
    lines: [
      { id: "e1", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "くうこうまでの よていを おしえて ください。", jaKanji: "空港までの予定を教えてください。", en: "Please tell me your plan for getting to the airport.", de: "Bitte erzählen Sie mir Ihren Plan für den Flughafen.", zh: "请告诉我去机场的计划。" } },
      { id: "e2", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "えきに ついてから、きっぷを かいます。", jaKanji: "駅に着いてから、切符を買います。", en: "After arriving at the station, I'll buy a ticket.", de: "Nachdem ich am Bahnhof angekommen bin, kaufe ich eine Fahrkarte.", zh: "到车站之后再买票。" } },
      { id: "e3", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "そのあとは どうしますか？", jaKanji: "その後はどうしますか？", en: "What do you do after that?", de: "Was machen Sie danach?", zh: "然后呢？" } },
      { id: "e4", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "きっぷを かったあとで、ホームに いきます。", jaKanji: "切符を買ったあとで、ホームに行きます。", en: "After buying the ticket, I go to the platform.", de: "Nachdem ich die Fahrkarte gekauft habe, gehe ich zum Bahnsteig.", zh: "买了票之后就去站台。" } },
      { id: "e5", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "でんしゃに のってから、なにを しますか？", jaKanji: "電車に乗ってから、何をしますか？", en: "What do you do after boarding the train?", de: "Was machen Sie, nachdem Sie in den Zug eingestiegen sind?", zh: "上了电车之后做什么？" } },
      { id: "e6", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "せきに すわってから、にもつを うえに おきます。", jaKanji: "席に座ってから、荷物を上に置きます。", en: "After sitting in my seat, I put my luggage up top.", de: "Nachdem ich mich gesetzt habe, lege ich mein Gepäck nach oben.", zh: "坐下之后把行李放到上面。" } },
      { id: "e7", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "くうこうでは まず なにを しますか？", jaKanji: "空港ではまず何をしますか？", en: "What do you do first at the airport?", de: "Was machen Sie zuerst am Flughafen?", zh: "在机场首先做什么？" } },
      { id: "e8", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "ついたあとで、チェックインを します。", jaKanji: "着いたあとで、チェックインをします。", en: "After arriving, I check in.", de: "Nachdem ich angekommen bin, checke ich ein.", zh: "到达之后办理登机手续。" } },
      { id: "e9", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "チェックインの あとは？", jaKanji: "チェックインのあとは？", en: "What's after check-in?", de: "Was kommt nach dem Check-in?", zh: "登机手续之后呢？" } },
      { id: "e10", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "チェックインしてから、セキュリティチェックを うけます。", jaKanji: "チェックインしてから、セキュリティチェックを受けます。", en: "After checking in, I go through the security check.", de: "Nach dem Check-in gehe ich durch die Sicherheitskontrolle.", zh: "办理手续之后接受安检。" } },
      { id: "e11", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "とうちゃくしたら、まず なにを しますか？", jaKanji: "到着したら、まず何をしますか？", en: "When you arrive, what do you do first?", de: "Wenn Sie ankommen, was machen Sie zuerst?", zh: "到达之后先做什么？" } },
      { id: "e12", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "にもつを うけとってから、ホテルに むかいます。", jaKanji: "荷物を受け取ってから、ホテルに向かいます。", en: "After picking up my luggage, I head to the hotel.", de: "Nachdem ich mein Gepäck abgeholt habe, fahre ich zum Hotel.", zh: "取了行李之后前往酒店。" } },
      { id: "e13", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "のりかえは ありますか？", jaKanji: "乗り換えはありますか？", en: "Do you have a transfer?", de: "Haben Sie einen Umstieg?", zh: "有换乘吗？" } },
      { id: "e14", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "はい、バスに のりかえたあとで、ホテルに つきます。", jaKanji: "はい、バスに乗り換えたあとで、ホテルに着きます。", en: "Yes, after transferring to a bus, I arrive at the hotel.", de: "Ja, nachdem ich in einen Bus umgestiegen bin, komme ich im Hotel an.", zh: "是的，换乘公交车之后就到酒店了。" } }
    ]
  },
  grammar: {
    ja: {
      title: { ja: "〜てから／〜あとで：じゅんばんを あらわす", jaKanji: "〜てから／〜あとで：順番を表す", en: "~Te Kara / ~Ato De: Expressing Sequence", de: "~Te Kara / ~Ato De: Reihenfolge ausdrücken", zh: "〜てから／〜あとで：表示顺序" },
      explanation: {
        ja: "「〜てから」は どうしの て-けい に つけて、「Aを してから、Bを する」（Aを した あと、すぐに Bを する）を あらわします。「〜あとで」は「Aした あとで、Bする」で、なめし より すこし かたい/ひろい かんかくで つかえます。どちらも、ふたつの どうさの じゅんばんを はっきり しめします。", jaKanji: "「〜てから」は動詞のて形に付けて、「Aをしてから、Bをする」（Aをしたあと、すぐにBをする）を表します。「〜あとで」は「Aしたあとで、Bする」で、なめしより少し硬い/広い感覚で使えます。どちらも、二つの動作の順番をはっきり示します。",
      ...
      chunks: [
        { id: "g1", translations: { ja: "しゅくだいを してから、テレビを みます。", jaKanji: "宿題をしてから、テレビを見ます。", en: "After doing my homework, I watch TV.", de: "Nachdem ich meine Hausaufgaben gemacht habe, sehe ich fern.", zh: "做完作业之后看电视。" } },
        { id: "g2", translations: { ja: "ごはんを たべたあとで、さんぽに いきます。", jaKanji: "ご飯を食べたあとで、散歩に行きます。", en: "After eating, I go for a walk.", de: "Nachdem ich gegessen habe, gehe ich spazieren.", zh: "吃完饭之后去散步。" } },
        { id: "g3", translations: { ja: "シャワーを あびてから、ねます。", jaKanji: "シャワーを浴びてから、寝ます。", en: "After taking a shower, I go to bed.", de: "Nachdem ich geduscht habe, gehe ich ins Bett.", zh: "洗完澡之后睡觉。" } },
        { id: "g4", translations: { ja: "かいぎが おわったあとで、れんらくします。", jaKanji: "会議が終わったあとで、連絡します。", en: "After the meeting ends, I'll contact you.", de: "Nachdem die Besprechung beendet ist, melde ich mich.", zh: "会议结束之后再联系。" } },
        { id: "g5", translations: { ja: "きっぷを かってから、ホームに はいります。", jaKanji: "切符を買ってから、ホームに入ります。", en: "After buying a ticket, I go onto the platform.", de: "Nachdem ich eine Fahrkarte gekauft habe, gehe ich auf den Bahnsteig.", zh: "买了票之后进站台。" } },
        { id: "g6", translations: { ja: "にほんに ついたあとで、れんらくを ください。", jaKanji: "日本に着いたあとで、連絡をください。", en: "Please contact me after you arrive in Japan.", de: "Bitte melden Sie sich, nachdem Sie in Japan angekommen sind.", zh: "到达日本之后请联系我。" } }
      ]
    }
  },
  grammarDrills: {
