...
export const topicCooking: TopicLesson = {
  ...
  vocab: [
    ...
    { id: "v02", category: "noun", translations: { ja: "ざいりょう", jaKanji: "材料", en: "ingredients", de: "Zutaten", zh: "食材" } },
    { id: "v03", category: "noun", translations: { ja: "なべ", jaKanji: "鍋", en: "pot", de: "Topf", zh: "锅" } },
    { id: "v04", category: "noun", translations: { ja: "フライパン", en: "frying pan", de: "Pfanne", zh: "平底锅" } },
    { id: "v05", category: "noun", translations: { ja: "ほうちょう", jaKanji: "包丁", en: "kitchen knife", de: "Küchenmesser", zh: "菜刀" } },
    { id: "v06", category: "noun", translations: { ja: "まないた", jaKanji: "まな板", en: "cutting board", de: "Schneidebrett", zh: "砧板" } },
    { id: "v07", category: "noun", translations: { ja: "あぶら", jaKanji: "油", en: "oil", de: "Öl", zh: "油" } },
    { id: "v08", category: "noun", translations: { ja: "しお", jaKanji: "塩", en: "salt", de: "Salz", zh: "盐" } },
    { id: "v09", category: "noun", translations: { ja: "さとう", jaKanji: "砂糖", en: "sugar", de: "Zucker", zh: "糖" } },
    { id: "v10", category: "noun", translations: { ja: "しょうゆ", jaKanji: "醤油", en: "soy sauce", de: "Sojasauce", zh: "酱油" } },
    { id: "v11", category: "noun", translations: { ja: "だし", jaKanji: "出汁", en: "soup stock", de: "Brühe", zh: "高汤" } },
    { id: "v12", category: "noun", translations: { ja: "あじ", jaKanji: "味", en: "taste", de: "Geschmack", zh: "味道" } },
    { id: "v13", category: "verb", translations: { ja: "きる", jaKanji: "切る", en: "to cut", de: "schneiden", zh: "切" } },
    { id: "v14", category: "verb", translations: { ja: "まぜる", jaKanji: "混ぜる", en: "to mix", de: "mischen", zh: "搅拌" } },
    { id: "v15", category: "verb", translations: { ja: "にる", jaKanji: "煮る", en: "to simmer, boil", de: "kochen, köcheln", zh: "炖" } },
    { id: "v16", category: "verb", translations: { ja: "やく", jaKanji: "焼く", en: "to grill, bake, fry", de: "braten, backen", zh: "烤，煎" } },
    { id: "v17", category: "verb", translations: { ja: "いためる", jaKanji: "炒める", en: "to stir-fry", de: "anbraten", zh: "炒" } },
    { id: "v18", category: "verb", translations: { ja: "あじみする", jaKanji: "味見する", en: "to taste-test", de: "abschmecken", zh: "尝味道" } },
    { id: "v19", category: "verb", translations: { ja: "はかる", jaKanji: "量る", en: "to measure", de: "abmessen", zh: "测量" } },
    { id: "v20", category: "verb", translations: { ja: "あたためる", jaKanji: "温める", en: "to warm up", de: "erwärmen", zh: "加热" } },
    { id: "v21", category: "verb", translations: { ja: "ひやす", jaKanji: "冷やす", en: "to cool, chill", de: "kühlen", zh: "冷却" } },
    { id: "v22", category: "verb", translations: { ja: "もりつける", jaKanji: "盛り付ける", en: "to plate, arrange food", de: "anrichten", zh: "摆盘" } },
    { id: "v23", category: "verb", translations: { ja: "てつだう", jaKanji: "手伝う", en: "to help", de: "helfen", zh: "帮忙" } },
    { id: "v24", category: "verb", translations: { ja: "ためす", jaKanji: "試す", en: "to try, test", de: "ausprobieren", zh: "尝试" } },
    { id: "v25", category: "adjective", translations: { ja: "あまい", jaKanji: "甘い", en: "sweet", de: "süß", zh: "甜的" } },
    { id: "v26", category: "adjective", translations: { ja: "からい", jaKanji: "辛い", en: "spicy", de: "scharf", zh: "辣的" } },
    ...
    { id: "v29", category: "noun", translations: { ja: "しんメニュー", jaKanji: "新メニュー", en: "new menu item", de: "neues Gericht", zh: "新菜品" } },
    { id: "v30", category: "noun", translations: { ja: "かてい", jaKanji: "過程", en: "process, procedure", de: "Vorgang", zh: "过程" } },
    { id: "v31", category: "adverb", translations: { ja: "ゆっくり", en: "slowly", de: "langsam", zh: "慢慢地" } },
    { id: "v32", category: "adverb", translations: { ja: "じょうずに", jaKanji: "上手に", en: "skillfully", de: "geschickt", zh: "熟练地" } }
  ],
  dialogueA: {
    title: { ja: "いっしょに りょうりを する", jaKanji: "一緒に料理をする", en: "Cooking Together", de: "Zusammen kochen", zh: "一起做饭" },
    lines: [
      { id: "d1", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "きょうは なにを つくりますか？", jaKanji: "今日は何を作りますか？", en: "What are we making today?", de: "Was machen wir heute?", zh: "今天做什么？" } },
      { id: "d2", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "レシピを みながら、あたらしい りょうりを つくって みましょう。", jaKanji: "レシピを見ながら、新しい料理を作ってみましょう。", en: "Let's try making a new dish while looking at the recipe.", de: "Lass uns ein neues Gericht ausprobieren, während wir auf das Rezept schauen.", zh: "边看食谱边尝试做新菜吧。" } },
      { id: "d3", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "いいですね！まず なにを きりますか？", jaKanji: "いいですね！まず何を切りますか？", en: "Sounds good! What do we cut first?", de: "Klingt gut! Was schneiden wir zuerst?", zh: "好啊！先切什么？" } },
      { id: "d4", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "やさいを きりながら、なべに おゆを わかします。", jaKanji: "野菜を切りながら、鍋にお湯を沸かします。", en: "While cutting the vegetables, we'll boil water in the pot.", de: "Während wir das Gemüse schneiden, kochen wir Wasser im Topf.", zh: "一边切菜一边在锅里烧水。" } },
      { id: "d5", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "しおを どのくらい いれますか？", jaKanji: "塩をどのくらい入れますか？", en: "How much salt should we add?", de: "Wie viel Salz sollen wir hinzufügen?", zh: "放多少盐？" } },
      { id: "d6", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "レシピを よみながら、はかって みて ください。", jaKanji: "レシピを読みながら、量ってみてください。", en: "Please try measuring it while reading the recipe.", de: "Bitte versuchen Sie, es abzumessen, während Sie das Rezept lesen.", zh: "边看食谱边试着量一下。" } },
      { id: "d7", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "あじみして みても いいですか？", jaKanji: "味見してみてもいいですか？", en: "May I try tasting it?", de: "Darf ich es probieren?", zh: "可以尝一下味道吗？" } },
      { id: "d8", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "はい、たべて みて ください。あまいですか？からいですか？", jaKanji: "はい、食べてみてください。甘いですか？辛いですか？", en: "Yes, please try it. Is it sweet? Spicy?", de: "Ja, bitte probieren Sie es. Ist es süß? Scharf?", zh: "好的，尝尝看。甜吗？辣吗？" } },
      { id: "d9", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "すこし しょっぱいです。しょうゆを へらして みましょう。", jaKanji: "少ししょっぱいです。醤油を減らしてみましょう。", en: "It's a bit salty. Let's try reducing the soy sauce.", de: "Es ist etwas salzig. Lass uns weniger Sojasauce ausprobieren.", zh: "有点咸。少放点酱油试试吧。" } },
      { id: "d10", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "はなしながら つくると、たのしいですね。", jaKanji: "話しながら作ると、楽しいですね。", en: "It's fun to cook while chatting.", de: "Es macht Spaß, beim Kochen zu plaudern.", zh: "一边聊天一边做饭真开心。" } },
      { id: "d11", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "つぎは やさいを いためて みましょうか。", jaKanji: "次は野菜を炒めてみましょうか。", en: "Shall we try stir-frying the vegetables next?", de: "Sollen wir als Nächstes das Gemüse anbraten?", zh: "接下来炒一下蔬菜好吗？" } },
      { id: "d12", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "ええ、あぶらを ひきながら、つよびで やきましょう。", jaKanji: "ええ、油をひきながら、強火で焼きましょう。", en: "Yes, let's fry it on high heat while adding oil.", de: "Ja, lass uns es bei hoher Hitze braten, während wir Öl hinzufügen.", zh: "好，一边放油一边用大火煎吧。" } },
      { id: "d13", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "さいごに どう もりつけますか？", jaKanji: "最後にどう盛り付けますか？", en: "How should we plate it at the end?", de: "Wie sollen wir es am Ende anrichten?", zh: "最后怎么摆盘？" } },
      { id: "d14", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "うつわを えらびながら、きれいに もりつけましょう。", jaKanji: "器を選びながら、きれいに盛り付けましょう。", en: "Let's plate it nicely while choosing the dish.", de: "Lass uns es schön anrichten, während wir das Geschirr auswählen.", zh: "一边选餐具一边漂亮地摆盘吧。" } }
    ]
  },
  dialogueB: {
    title: { ja: "あたらしい レシピに ちょうせんする", jaKanji: "新しいレシピに挑戦する", en: "Trying a New Recipe", de: "Ein neues Rezept ausprobieren", zh: "尝试新食谱" },
    lines: [
      { id: "e1", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "その レシピは あたらしいですか？", jaKanji: "そのレシピは新しいですか？", en: "Is that recipe new?", de: "Ist das ein neues Rezept?", zh: "那个食谱是新的吗？" } },
      { id: "e2", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "はい、しんメニューを つくって みたいと おもって います。", jaKanji: "はい、新メニューを作ってみたいと思っています。", en: "Yes, I've been wanting to try making a new dish.", de: "Ja, ich wollte schon immer ein neues Gericht ausprobieren.", zh: "是的，我一直想做个新菜试试。" } },
      { id: "e3", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "どんな かていで つくりますか？", jaKanji: "どんな過程で作りますか？", en: "What's the process for making it?", de: "Wie ist der Vorgang, um es zu machen?", zh: "是什么样的制作过程？" } },
      { id: "e4", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "まず、ざいりょうを はかりながら、じゅんびします。", jaKanji: "まず、材料を量りながら、準備します。", en: "First, I prepare things while measuring the ingredients.", de: "Zuerst bereite ich alles vor, während ich die Zutaten abmesse.", zh: "首先，一边量食材一边准备。" } },
      { id: "e5", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "むずかしそうな かていは ありますか？", jaKanji: "難しそうな過程はありますか？", en: "Is there a step that looks difficult?", de: "Gibt es einen Schritt, der schwierig aussieht?", zh: "有看起来很难的步骤吗？" } },
      { id: "e6", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "だしを とる かていが むずかしそうです。ためして みます。", jaKanji: "出汁を取る過程が難しそうです。試してみます。", en: "The step of making soup stock looks difficult. I'll give it a try.", de: "Der Schritt, die Brühe zu machen, sieht schwierig aus. Ich probiere es aus.", zh: "熬高汤的步骤看起来很难。试试看吧。" } },
      { id: "e7", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "しっぱいしても だいじょうぶですよ。", jaKanji: "失敗しても大丈夫ですよ。", en: "It's okay even if you fail.", de: "Es ist auch okay, wenn es misslingt.", zh: "就算失败了也没关系。" } },
      { id: "e8", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "そうですね。テレビを みながら、きんちょうせずに つくります。", jaKanji: "そうですね。テレビを見ながら、緊張せずに作ります。", en: "You're right. I'll make it without being nervous, while watching TV.", de: "Sie haben recht. Ich mache es entspannt, während ich fernsehe.", zh: "说得对。一边看电视一边轻松地做。" } },
      { id: "e9", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "できあがったら、あじみさせて くださいね。", jaKanji: "できあがったら、味見させてくださいね。", en: "When it's done, please let me taste it.", de: "Wenn es fertig ist, lassen Sie mich bitte probieren.", zh: "做好之后请让我尝尝。" } },
      { id: "e10", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "もちろん です。かんせいしたら、よんで みます。", jaKanji: "もちろんです。完成したら、呼んでみます。", en: "Of course. When it's finished, I'll call you.", de: "Natürlich. Wenn es fertig ist, rufe ich Sie.", zh: "当然。做好了会叫你的。" } },
      { id: "e11", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "あじつけは どう するつもりですか？", jaKanji: "味付けはどうするつもりですか？", en: "How are you planning to season it?", de: "Wie planen Sie zu würzen?", zh: "打算怎么调味？" } },
      { id: "e12", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "あじみを しながら、すこしずつ ちょうせいします。", jaKanji: "味見をしながら、少しずつ調整します。", en: "I'll adjust little by little while tasting.", de: "Ich passe es nach und nach an, während ich probiere.", zh: "一边尝味道一边一点点调整。" } },
      { id: "e13", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "がんばって ください。たのしみに して います。", jaKanji: "頑張ってください。楽しみにしています。", en: "Good luck. I'm looking forward to it.", de: "Viel Erfolg. Ich freue mich darauf.", zh: "加油。很期待呢。" } },
      { id: "e14", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "ありがとう ございます。おいしく できるように がんばります。", jaKanji: "ありがとうございます。美味しくできるように頑張ります。", en: "Thank you. I'll do my best to make it delicious.", de: "Danke. Ich werde mein Bestes geben, damit es lecker wird.", zh: "谢谢。我会努力做得好吃的。" } }
    ]
  },
  grammar: {
    ja: {
      title: { ja: "〜ながら／〜てみる：どうじの どうさと ためすこと", jaKanji: "〜ながら／〜てみる：同時の動作と試すこと", en: "~Nagara / ~Te Miru: Simultaneous Actions and Trying", de: "~Nagara / ~Te Miru: Gleichzeitige Handlungen und Ausprobieren", zh: "〜ながら／〜てみる：同时动作与尝试" },
      explanation: {
        ja: "「〜ながら」は どうしの ます-けい の ごびを とって つけ、ふたつの どうさを おなじ ひとが どうじに する ことを あらわします（「テレビを みながら、しょくじを します」）。「〜てみる」は どうしの て-けい に つけて、けっかが わからない ことを ために して みる ことを あらわします（「たべて みます」＝たべた けっかを たしかめる ために たべる）。", jaKanji: "「〜ながら」は動詞のます形の語尾を取って付け、二つの動作を同じ人が同時にすることを表します（「テレビを見ながら、食事をします」）。「〜てみる」は動詞のて形に付けて、結果が分からないことをためにしてみることを表します（「食べてみます」＝食べた結果を確かめるために食べる）。",
      ...
      chunks: [
        { id: "g1", translations: { ja: "おんがくを ききながら、りょうりを します。", jaKanji: "音楽を聞きながら、料理をします。", en: "I cook while listening to music.", de: "Ich koche, während ich Musik höre.", zh: "边听音乐边做饭。" } },
        { id: "g2", translations: { ja: "あたらしい みせで たべて みました。", jaKanji: "新しい店で食べてみました。", en: "I tried eating at a new restaurant.", de: "Ich habe versucht, in einem neuen Restaurant zu essen.", zh: "尝试在新店吃了饭。" } },
        { id: "g3", translations: { ja: "レシピを よみながら、つくって みます。", jaKanji: "レシピを読みながら、作ってみます。", en: "I'll try making it while reading the recipe.", de: "Ich versuche es zu machen, während ich das Rezept lese.", zh: "边看食谱边试着做。" } },
        { id: "g4", translations: { ja: "この ふくを きて みても いいですか。", jaKanji: "この服を着てみてもいいですか。", en: "May I try wearing this clothing?", de: "Darf ich diese Kleidung anprobieren?", zh: "可以试穿这件衣服吗？" } },
        { id: "g5", translations: { ja: "はなしながら、あるきます。", jaKanji: "話しながら、歩きます。", en: "I walk while talking.", de: "Ich gehe, während ich rede.", zh: "边走边聊天。" } },
        { id: "g6", translations: { ja: "あたらしい ことばを つかって みました。", jaKanji: "新しい言葉を使ってみました。", en: "I tried using a new word.", de: "Ich habe versucht, ein neues Wort zu verwenden.", zh: "试着用了一个新词。" } }
      ]
    }
  },
  grammarDrills: {
