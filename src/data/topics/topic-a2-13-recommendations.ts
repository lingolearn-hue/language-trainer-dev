...
export const topicRecommendations: TopicLesson = {
  id: "topic-a2-13-recommendations",
  lessonNumber: 13,
  level: "A2",
  topicName: {
    ja: "おすすめ",
  ...
  vocab: [
    ...
    { id: "v02", category: "noun", translations: { ja: "かんこうち", jaKanji: "観光地", en: "tourist spot", de: "Touristenort", zh: "旅游景点" } },
    { id: "v03", category: "noun", translations: { ja: "めいしょ", jaKanji: "名所", en: "famous place", de: "berühmter Ort", zh: "名胜" } },
    { id: "v04", category: "noun", translations: { ja: "めいぶつ", jaKanji: "名物", en: "local specialty", de: "lokale Spezialität", zh: "特产" } },
    { id: "v05", category: "noun", translations: { ja: "とくさんひん", jaKanji: "特産品", en: "local product", de: "regionales Produkt", zh: "土特产" } },
    { id: "v06", category: "noun", translations: { ja: "やど", jaKanji: "宿", en: "lodging", de: "Unterkunft", zh: "住处" } },
    { id: "v07", category: "noun", translations: { ja: "しゅくはく", jaKanji: "宿泊", en: "accommodation", de: "Unterbringung", zh: "住宿" } },
    { id: "v08", category: "noun", translations: { ja: "ちいき", jaKanji: "地域", en: "area, region", de: "Region", zh: "地区" } },
    { id: "v09", category: "noun", translations: { ja: "かんこうきゃく", jaKanji: "観光客", en: "tourist", de: "Tourist(in)", zh: "游客" } },
    { id: "v10", category: "noun", translations: { ja: "ガイドブック", en: "guidebook", de: "Reiseführer", zh: "导游手册" } },
    { id: "v11", category: "noun", translations: { ja: "かんこうあんない", jaKanji: "観光案内", en: "tourist information", de: "Touristeninformation", zh: "旅游咨询" } },
    { id: "v12", category: "noun", translations: { ja: "けしき", jaKanji: "景色", en: "scenery", de: "Landschaft", zh: "风景" } },
    { id: "v13", category: "noun", translations: { ja: "よてい", jaKanji: "予定", en: "plan", de: "Plan", zh: "计划" } },
    { id: "v14", category: "noun", translations: { ja: "たびさき", jaKanji: "旅先", en: "travel destination", de: "Reiseziel", zh: "旅行目的地" } },
    { id: "v15", category: "noun", translations: { ja: "きせつ", jaKanji: "季節", en: "season", de: "Jahreszeit", zh: "季节" } },
    { id: "v16", category: "verb", translations: { ja: "たずねる", jaKanji: "訪ねる", en: "to visit", de: "besuchen", zh: "拜访" } },
    { id: "v17", category: "verb", translations: { ja: "あんないする", jaKanji: "案内する", en: "to guide", de: "führen", zh: "带路" } },
    { id: "v18", category: "verb", translations: { ja: "さんかする", jaKanji: "参加する", en: "to participate", de: "teilnehmen", zh: "参加" } },
    { id: "v19", category: "verb", translations: { ja: "たいけんする", jaKanji: "体験する", en: "to experience", de: "erleben", zh: "体验" } },
    { id: "v20", category: "verb", translations: { ja: "でかける", jaKanji: "出かける", en: "to go out", de: "ausgehen", zh: "出门" } },
    { id: "v21", category: "verb", translations: { ja: "しらべる", jaKanji: "調べる", en: "to look up, research", de: "recherchieren", zh: "查找" } },
    { id: "v22", category: "verb", translations: { ja: "えらぶ", jaKanji: "選ぶ", en: "to choose", de: "wählen", zh: "选择" } },
    { id: "v23", category: "verb", translations: { ja: "すすめる", jaKanji: "勧める", en: "to recommend", de: "empfehlen", zh: "推荐" } },
    { id: "v24", category: "verb", translations: { ja: "たのしめる", jaKanji: "楽しめる", en: "to be able to enjoy", de: "genießen können", zh: "能享受" } },
    { id: "v25", category: "verb", translations: { ja: "かんどうする", jaKanji: "感動する", en: "to be moved, touched", de: "gerührt sein", zh: "感动" } },
    { id: "v26", category: "adjective", translations: { ja: "にぎやかな", jaKanji: "賑やかな", en: "lively", de: "lebhaft", zh: "热闹" } },
    { id: "v27", category: "adjective", translations: { ja: "しずかな", jaKanji: "静かな", en: "quiet", de: "ruhig", zh: "安静" } },
    { id: "v28", category: "adjective", translations: { ja: "ゆうめいな", jaKanji: "有名な", en: "famous", de: "berühmt", zh: "有名" } },
    { id: "v29", category: "adverb", translations: { ja: "かならず", jaKanji: "必ず", en: "certainly", de: "sicherlich", zh: "一定" } },
    { id: "v30", category: "adverb", translations: { ja: "もしかしたら", en: "maybe, perhaps", de: "vielleicht", zh: "也许" } }
  ],
  dialogueA: {
    title: { ja: "ばしょを すすめる", jaKanji: "場所を勧める", en: "Recommending Places", de: "Orte empfehlen", zh: "推荐地方" },
    lines: [
      { id: "d1", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "きょうとに いくなら、どこが いいですか？", jaKanji: "京都に行くなら、どこがいいですか？", en: "If I'm going to Kyoto, where's good to go?", de: "Wenn ich nach Kyoto fahre, wohin sollte ich gehen?", zh: "如果去京都的话，哪里好？" } },
      { id: "d2", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "しずかな ばしょが すきなら、あの おてらが いいですよ。", jaKanji: "静かな場所が好きなら、あのお寺がいいですよ。", en: "If you like quiet places, that temple is good.", de: "Wenn Sie ruhige Orte mögen, ist der Tempel dort gut.", zh: "如果喜欢安静的地方，那座寺庙不错。" } },
      { id: "d3", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "けしきも きれいですか？", jaKanji: "景色もきれいですか？", en: "Is the scenery pretty too?", de: "Ist die Landschaft auch schön?", zh: "风景也很漂亮吗？" } },
      { id: "d4", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "はい、あきに いくと いいですよ。もみじが すばらしいです。", jaKanji: "はい、秋に行くといいですよ。紅葉が素晴らしいです。", en: "Yes, it's good to go in autumn. The autumn leaves are wonderful.", de: "Ja, es ist gut, im Herbst dorthin zu gehen. Das Herbstlaub ist wunderbar.", zh: "是的，秋天去比较好。红叶很棒。" } },
      { id: "d5", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "ひとが おおいかもしれませんね。", jaKanji: "人が多いかもしれませんね。", en: "There might be a lot of people, though.", de: "Es könnte aber viele Leute geben.", zh: "可能人会很多吧。" } },
      { id: "d6", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "そうですね。あさ はやく いくと いいですよ。", jaKanji: "そうですね。朝早く行くといいですよ。", en: "That's true. It's good to go early in the morning.", de: "Stimmt. Es ist gut, früh am Morgen hinzugehen.", zh: "是啊。早上早点去比较好。" } },
      { id: "d7", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "にぎやかな ばしょも しりたいです。", jaKanji: "賑やかな場所も知りたいです。", en: "I'd also like to know a lively place.", de: "Ich möchte auch einen lebhaften Ort kennenlernen.", zh: "也想知道热闹的地方。" } },
      { id: "d8", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "かいものを したいなら、あの しょうてんがいが いいです。", jaKanji: "買い物をしたいなら、あの商店街がいいです。", en: "If you want to shop, that shopping street is good.", de: "Wenn Sie einkaufen möchten, ist die Einkaufsstraße dort gut.", zh: "如果想购物的话，那条商店街不错。" } },
      { id: "d9", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "めいぶつは なにが ありますか？", jaKanji: "名物は何がありますか？", en: "What local specialties are there?", de: "Welche lokalen Spezialitäten gibt es?", zh: "有什么特产？" } },
      { id: "d10", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "おかしが ゆうめいです。かってみると いいですよ。", jaKanji: "お菓子が有名です。買ってみるといいですよ。", en: "Sweets are famous. It'd be good to try buying some.", de: "Süßigkeiten sind berühmt. Es wäre gut, welche zu kaufen.", zh: "点心很有名。买来试试看也不错。" } },
      { id: "d11", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "やどは どこが いいと おもいますか？", jaKanji: "宿はどこがいいと思いますか？", en: "Where do you think is a good place to stay?", de: "Wo, denken Sie, ist eine gute Unterkunft?", zh: "你觉得住哪儿好？" } },
      { id: "d12", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "でんとうてきな やどに とまりたいなら、りょかんが おすすめです。", jaKanji: "伝統的な宿に泊まりたいなら、旅館がおすすめです。", en: "If you want to stay in a traditional lodging, I recommend a ryokan.", de: "Wenn Sie in einer traditionellen Unterkunft übernachten möchten, empfehle ich ein Ryokan.", zh: "如果想住传统的住处，推荐旅馆。" } },
      { id: "d13", speaker: { ja: "あい", en: "Ai", de: "Ai", zh: "爱" }, translations: { ja: "たかいかもしれませんね。", jaKanji: "高いかもしれませんね。", en: "It might be expensive, though.", de: "Es könnte aber teuer sein.", zh: "可能会很贵吧。" } },
      { id: "d14", speaker: { ja: "けん", en: "Ken", de: "Ken", zh: "健" }, translations: { ja: "はやく よやくすると いいですよ。やすい プランも ありますから。", jaKanji: "早く予約するといいですよ。安いプランもありますから。", en: "It's good to book early. There are cheap plans too.", de: "Es ist gut, früh zu reservieren. Es gibt auch günstige Angebote.", zh: "早点预订比较好。也有便宜的方案。" } }
    ]
  },
  dialogueB: {
    title: { ja: "はじめての ひとに アドバイスする", jaKanji: "初めての人にアドバイスする", en: "Advising a Visitor", de: "Einen Besucher beraten", zh: "给游客建议" },
    lines: [
      { id: "e1", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "はじめて にほんに くる ひとに アドバイスを おねがいします。", jaKanji: "初めて日本に来る人にアドバイスをお願いします。", en: "Please give some advice to someone coming to Japan for the first time.", de: "Bitte geben Sie einen Rat für jemanden, der zum ersten Mal nach Japan kommt.", zh: "请给第一次来日本的人一些建议。" } },
      { id: "e2", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "しんかんせんに のるなら、はやめに きっぷを かうと いいですよ。", jaKanji: "新幹線に乗るなら、早めに切符を買うといいですよ。", en: "If you're going to ride the shinkansen, it's good to buy tickets early.", de: "Wenn Sie den Shinkansen nehmen, ist es gut, die Fahrkarten früh zu kaufen.", zh: "如果要坐新干线的话，早点买票比较好。" } },
      { id: "e3", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "ガイドブックは ひつようですか？", jaKanji: "ガイドブックは必要ですか？", en: "Is a guidebook necessary?", de: "Ist ein Reiseführer notwendig?", zh: "需要导游手册吗？" } },
      { id: "e4", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "アプリを つかうなら、ガイドブックは いらないかもしれません。", jaKanji: "アプリを使うなら、ガイドブックはいらないかもしれません。", en: "If you're using an app, you might not need a guidebook.", de: "Wenn Sie eine App verwenden, brauchen Sie vielleicht keinen Reiseführer.", zh: "如果用应用软件的话，可能就不需要导游手册了。" } },
      { id: "e5", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "どんな かんこうちが おすすめですか？", jaKanji: "どんな観光地がおすすめですか？", en: "What kind of tourist spots do you recommend?", de: "Welche Art von Touristenorten empfehlen Sie?", zh: "推荐什么样的旅游景点？" } },
      { id: "e6", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "しぜんが すきなら、やまが おおい ちいきに いくと いいです。", jaKanji: "自然が好きなら、山が多い地域に行くといいです。", en: "If you like nature, it's good to go to areas with lots of mountains.", de: "Wenn Sie die Natur mögen, ist es gut, in Gebiete mit vielen Bergen zu fahren.", zh: "如果喜欢自然的话，去多山的地区比较好。" } },
      { id: "e7", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "げんきんは たくさん もっていくべきですか？", jaKanji: "現金はたくさん持っていくべきですか？", en: "Should I bring a lot of cash?", de: "Sollte ich viel Bargeld mitnehmen?", zh: "应该带很多现金吗？" } },
      { id: "e8", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "しょうてんがいなら、カードが つかえないかもしれません。すこし もっていくと いいです。", jaKanji: "商店街なら、カードが使えないかもしれません。少し持っていくといいです。", en: "In shopping streets, cards might not work. It'd be good to bring some.", de: "In Einkaufsstraßen funktionieren Karten vielleicht nicht. Es wäre gut, etwas mitzunehmen.", zh: "在商店街的话，可能不能刷卡。带一点比较好。" } },
      { id: "e9", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "しゅくはくは どこが いいですか？", jaKanji: "宿泊はどこがいいですか？", en: "Where's good to stay?", de: "Wo ist es gut zu übernachten?", zh: "住哪里好？" } },
      { id: "e10", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "えきの ちかくに とまると べんりですよ。", jaKanji: "駅の近くに泊まると便利ですよ。", en: "It's convenient to stay near the station.", de: "Es ist praktisch, in der Nähe des Bahnhofs zu übernachten.", zh: "住在车站附近很方便。" } },
      { id: "e11", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "かんこうきゃくが おおい きせつは ありますか？", jaKanji: "観光客が多い季節はありますか？", en: "Is there a season with a lot of tourists?", de: "Gibt es eine Saison mit vielen Touristen?", zh: "有游客多的季节吗？" } },
      { id: "e12", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "はるなら、さくらを みに くる ひとが おおいかもしれません。", jaKanji: "春なら、桜を見に来る人が多いかもしれません。", en: "In spring, there might be a lot of people coming to see the cherry blossoms.", de: "Im Frühling könnte es viele Leute geben, die die Kirschblüten sehen kommen.", zh: "春天的话，可能会有很多人来赏樱。" } },
      { id: "e13", speaker: { ja: "みほ", en: "Miho", de: "Miho", zh: "美穗" }, translations: { ja: "さいごに、ひとつ アドバイスを ください。", jaKanji: "最後に、一つアドバイスをください。", en: "Lastly, please give one piece of advice.", de: "Zum Schluss, geben Sie mir bitte noch einen Rat.", zh: "最后，请给我一个建议。" } },
      { id: "e14", speaker: { ja: "そら", en: "Sora", de: "Sora", zh: "空" }, translations: { ja: "よていを つめすぎないと いいですよ。ゆっくり たのしめますから。", jaKanji: "予定を詰めすぎないといいですよ。ゆっくり楽しめますから。", en: "It's good not to over-pack your schedule. You can enjoy it more relaxed that way.", de: "Es ist gut, den Zeitplan nicht zu überladen. So können Sie es entspannter genießen.", zh: "不要把行程排得太满比较好。这样可以悠闲地享受。" } }
    ]
  },
  grammar: {
    ja: {
      title: { ja: "〜なら／〜といい／〜かもしれない：おすすめと よそく", jaKanji: "〜なら／〜といい／〜かもしれない：おすすめと予測", en: "~Nara / ~To Ii / ~Kamoshirenai: Recommendations and Predictions", de: "~Nara / ~To Ii / ~Kamoshirenai: Empfehlungen und Vermutungen", zh: "〜なら／〜といい／〜かもしれない：推荐与推测" },
      explanation: {
        ja: "「〜なら」は「もし Aの ことなら」と、あいての はなした トピックを うけて じょうけんを しめします。「〜といい」は「Bを すると いい けっかに なる」という アドバイスを あらわします。「〜かもしれない」は「もしかしたら そうかもしれない」と、かくじつでは ない よそくを あらわします。", jaKanji: "「〜なら」は「もしAのことなら」と、相手の話したトピックを受けて条件を示します。「〜といい」は「Bをするといい結果になる」というアドバイスを表します。「〜かもしれない」は「もしかしたらそうかもしれない」と、確実ではない予測を表します。",
      ...
      chunks: [
        { id: "g1", translations: { ja: "きょうとに いくなら、あきが いいですよ。", jaKanji: "京都に行くなら、秋がいいですよ。", en: "If you're going to Kyoto, autumn is good.", de: "Wenn Sie nach Kyoto fahren, ist der Herbst gut.", zh: "如果去京都的话，秋天比较好。" } },
        { id: "g2", translations: { ja: "たべものが すきなら、この みせを すすめます。", jaKanji: "食べ物が好きなら、この店を勧めます。", en: "If you like food, I recommend this shop.", de: "Wenn Sie Essen mögen, empfehle ich dieses Geschäft.", zh: "如果喜欢美食的话，推荐这家店。" } },
        { id: "g3", translations: { ja: "はやく でかけると いいですよ。", jaKanji: "早く出かけるといいですよ。", en: "It would be good to leave early.", de: "Es wäre gut, früh loszugehen.", zh: "早点出发比较好。" } },
        { id: "g4", translations: { ja: "ガイドブックを みると いいです。", jaKanji: "ガイドブックを見るといいです。", en: "It would be good to look at a guidebook.", de: "Es wäre gut, einen Reiseführer anzuschauen.", zh: "看看导游手册比较好。" } },
        { id: "g5", translations: { ja: "あめが ふるかもしれません。", jaKanji: "雨が降るかもしれません。", en: "It might rain.", de: "Es könnte regnen.", zh: "可能会下雨。" } },
        { id: "g6", translations: { ja: "その みせは しまって いるかもしれません。", jaKanji: "その店は閉まっているかもしれません。", en: "That shop might be closed.", de: "Das Geschäft könnte geschlossen sein.", zh: "那家店可能已经关门了。" } }
      ]
    }
  },
  pronunciation: {
