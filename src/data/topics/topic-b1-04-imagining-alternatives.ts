...
export const topicImaginingAlternatives: TopicLesson = {
  ...
  vocab: [
    { id: "v01", category: "grammar", translations: { ja: "もし", en: "if" } },
    { id: "v02", category: "noun", translations: { ja: "りんじしゅうにゅう", jaKanji: "臨時収入", en: "windfall, unexpected money" } },
    { id: "v03", category: "noun", translations: { ja: "たからくじ", jaKanji: "宝くじ", en: "lottery" } },
    { id: "v04", category: "verb", translations: { ja: "あたる", jaKanji: "当たる", en: "to win (a prize)" } },
    { id: "v05", category: "noun", translations: { ja: "ひゃくまん", jaKanji: "百万", en: "million" } },
    { id: "v06", category: "verb", translations: { ja: "そうぞうする", jaKanji: "想像する", en: "to imagine" } },
    { id: "v07", category: "noun", translations: { ja: "だいあん", jaKanji: "代案", en: "alternative" } },
    { id: "v08", category: "noun", translations: { ja: "みち", jaKanji: "道", en: "path (in life)" } },
    { id: "v09", category: "noun", translations: { ja: "せんたく", jaKanji: "選択", en: "choice" } },
    { id: "v10", category: "verb", translations: { ja: "えらぶ", jaKanji: "選ぶ", en: "to choose" } },
    { id: "v11", category: "noun", translations: { ja: "きかい", jaKanji: "機会", en: "opportunity" } },
    { id: "v12", category: "verb", translations: { ja: "のがす", jaKanji: "逃す", en: "to miss (an opportunity)" } },
    { id: "v13", category: "noun", translations: { ja: "こうかい", jaKanji: "後悔", en: "regret" } },
    { id: "v14", category: "verb", translations: { ja: "こうかいする", jaKanji: "後悔する", en: "to regret" } },
    { id: "v15", category: "noun", translations: { ja: "あこがれの しごと", jaKanji: "憧れの仕事", en: "dream job" } },
    { id: "v16", category: "verb", translations: { ja: "とうしする", jaKanji: "投資する", en: "to invest" } },
    { id: "v17", category: "noun", translations: { ja: "ちょきん", jaKanji: "貯金", en: "savings" } },
    { id: "v18", category: "verb", translations: { ja: "ちょきんする", jaKanji: "貯金する", en: "to save (money)" } },
    { id: "v19", category: "verb", translations: { ja: "きふする", jaKanji: "寄付する", en: "to donate" } },
    { id: "v20", category: "noun", translations: { ja: "じぜんだんたい", jaKanji: "慈善団体", en: "charity" } },
    { id: "v21", category: "verb", translations: { ja: "やめる", jaKanji: "辞める", en: "to quit (a job)" } },
    { id: "v22", category: "verb", translations: { ja: "ついきゅうする", jaKanji: "追求する", en: "to pursue (a goal, dream)" } },
    { id: "v23", category: "noun", translations: { ja: "リスク", en: "risk" } },
    { id: "v24", category: "verb", translations: { ja: "リスクを おかす", jaKanji: "リスクを冒す", en: "to take a risk" } },
    { id: "v25", category: "noun", translations: { ja: "あんてい", jaKanji: "安定", en: "stability" } },
    { id: "v26", category: "noun", translations: { ja: "ぼうけん", jaKanji: "冒険", en: "adventure" } },
    { id: "v27", category: "noun", translations: { ja: "かのうせい", jaKanji: "可能性", en: "possibility" } },
    { id: "v28", category: "grammar", translations: { ja: "もし〜だったら", en: "what if ~" } },
    { id: "v29", category: "adverb", translations: { ja: "げんじつてきに", jaKanji: "現実的に", en: "realistically" } },
    { id: "v30", category: "adverb", translations: { ja: "りそうてきに", jaKanji: "理想的に", en: "ideally" } }
  ],
  dialogueA: {
    title: { ja: "おもいがけない おかねの はなし", jaKanji: "思いがけないお金の話", en: "What Would You Do With a Windfall" },
    lines: [
      { id: "d1", speaker: { ja: "あい", en: "Ai" }, translations: { ja: "たからくじに あたったら、なにを する？", jaKanji: "宝くじに当たったら、何をする？", en: "If you won the lottery, what would you do?" } },
      { id: "d2", speaker: { ja: "けん", en: "Ken" }, translations: { ja: "ひゃくまんドル あたったら、たぶん さいしょに せかいじゅうを りょこうすると おもう。", jaKanji: "百万ドル当たったら、たぶん最初に世界中を旅行すると思う。", en: "If I won a million dollars, I would probably travel the world first." } },
      { id: "d3", speaker: { ja: "あい", en: "Ai" }, translations: { ja: "すごいね。しごとは つづける？", jaKanji: "すごいね。仕事は続ける？", en: "That sounds amazing. Would you keep working?" } },
      { id: "d4", speaker: { ja: "けん", en: "Ken" }, translations: { ja: "そんなに おかねが あったら、もう はたらく ひつようは ないと おもう。", jaKanji: "そんなにお金があったら、もう働く必要はないと思う。", en: "If I had that much money, I wouldn't need to work anymore." } },
      { id: "d5", speaker: { ja: "あい", en: "Ai" }, translations: { ja: "ほんとう？わたしは しごとが なかったら たいくつすると おもう。", jaKanji: "本当？私は仕事がなかったら退屈すると思う。", en: "Really? I think I'd get bored without a job." } },
      { id: "d6", speaker: { ja: "けん", en: "Ken" }, translations: { ja: "じゆうな じかんが あったら、えを かくのに つかいたいな。", jaKanji: "自由な時間があったら、絵を描くのに使いたいな。", en: "If I had free time, I would spend it painting." } },
      { id: "d7", speaker: { ja: "あい", en: "Ai" }, translations: { ja: "すてきな ゆめだね。きふも する？", jaKanji: "素敵な夢だね。寄付もする？", en: "That's a nice dream. Would you donate any of it?" } },
      { id: "d8", speaker: { ja: "けん", en: "Ken" }, translations: { ja: "よぶんな おかねが あったら、ぜったい じぜんだんたいに きふすると おもう。", jaKanji: "余分なお金があったら、絶対慈善団体に寄付すると思う。", en: "If I had extra money, I would definitely donate to a charity." } },
      { id: "d9", speaker: { ja: "あい", en: "Ai" }, translations: { ja: "どの だんたいを えらぶ？", jaKanji: "どの団体を選ぶ？", en: "Which charity would you choose?" } },
      { id: "d10", speaker: { ja: "けん", en: "Ken" }, translations: { ja: "えらべるなら、きょういく プログラムを ささえたいな。", jaKanji: "選べるなら、教育プログラムを支えたいな。", en: "If I could choose, I would support education programs." } },
      { id: "d11", speaker: { ja: "あい", en: "Ai" }, translations: { ja: "かぞくには どう する？", jaKanji: "家族にはどうする？", en: "What about your family?" } },
      { id: "d12", speaker: { ja: "けん", en: "Ken" }, translations: { ja: "かぞくが たすけを ひつようとしたら、まず かぞくの めんどうを みたいな。", jaKanji: "家族が助けを必要としたら、まず家族の面倒を見たいな。", en: "If my family needed help, I would take care of them first." } },
      { id: "d13", speaker: { ja: "あい", en: "Ai" }, translations: { ja: "やさしい けいかくだね。", jaKanji: "優しい計画だね。", en: "That's a thoughtful plan." } },
      { id: "d14", speaker: { ja: "けん", en: "Ken" }, translations: { ja: "まあ、ただの そうぞうだけど、かんがえるのは たのしいね。", jaKanji: "まあ、ただの想像だけど、考えるのは楽しいね。", en: "Well, it's just imagination, but it's fun to think about." } }
    ]
  },
  dialogueB: {
    title: { ja: "べつの キャリアを そうぞうする", jaKanji: "別のキャリアを想像する", en: "Imagining a Different Career Path" },
    lines: [
      { id: "e1", speaker: { ja: "みほ", en: "Miho" }, translations: { ja: "やりなおせるなら、どんな しごとを えらぶ？", jaKanji: "やり直せるなら、どんな仕事を選ぶ？", en: "If you could start over, what career would you choose?" } },
      { id: "e2", speaker: { ja: "けん", en: "Ken" }, translations: { ja: "もういちど わかかったら、たぶん いしゃに なると おもう。", jaKanji: "もう一度若かったら、たぶん医者になると思う。", en: "If I were young again, I would probably become a doctor." } },
      { id: "e3", speaker: { ja: "みほ", en: "Miho" }, translations: { ja: "どうして いしゃなの？", jaKanji: "どうして医者なの？", en: "Why a doctor?" } },
      { id: "e4", speaker: { ja: "けん", en: "Ken" }, translations: { ja: "ひとを ちょくせつ たすけられたら、もっと じゅうじつすると おもうんだ。", jaKanji: "人を直接助けられたら、もっと充実すると思うんだ。", en: "If I could help people directly, I think I would feel more fulfilled." } },
      { id: "e5", speaker: { ja: "みほ", en: "Miho" }, translations: { ja: "なるほどね。いまの しごとは どう？", jaKanji: "なるほどね。今の仕事はどう？", en: "That makes sense. What about your current job?" } },
      { id: "e6", speaker: { ja: "けん", en: "Ken" }, translations: { ja: "いま やめるなら、あんていを うしなうから、きめるのは むずかしいな。", jaKanji: "今辞めるなら、安定を失うから、決めるのは難しいな。", en: "If I quit now, I would lose my stability, so it's hard to decide." } },
      { id: "e7", speaker: { ja: "みほ", en: "Miho" }, translations: { ja: "その みちを えらばなかった ことを こうかいしてる？", jaKanji: "その道を選ばなかった事を後悔してる？", en: "Do you regret not choosing that path?" } },
      { id: "e8", speaker: { ja: "けん", en: "Ken" }, translations: { ja: "この しごとを えらんでいなかったら、ほかの きかいも のがしていたかもしれない。", jaKanji: "この仕事を選んでいなかったら、他の機会も逃していたかもしれない。", en: "If I hadn't chosen this job, I might have missed other opportunities too." } },
      { id: "e9", speaker: { ja: "みほ", en: "Miho" }, translations: { ja: "そうだね。どの せんたくにも トレードオフが あるよね。", jaKanji: "そうだね。どの選択にもトレードオフがあるよね。", en: "That's true. Every choice has trade-offs." } },
      { id: "e10", speaker: { ja: "けん", en: "Ken" }, translations: { ja: "いま リスクを おかしたら、じんせいが まったく かわるかもしれない。", jaKanji: "今リスクを冒したら、人生が全く変わるかもしれない。", en: "If I took a risk now, my life could be completely different." } },
      { id: "e11", speaker: { ja: "みほ", en: "Miho" }, translations: { ja: "その リスクを おかす？", jaKanji: "そのリスクを冒す？", en: "Would you take that risk?" } },
      { id: "e12", speaker: { ja: "けん", en: "Ken" }, translations: { ja: "もっと ゆうきが あったら、たぶん おかすと おもう。", jaKanji: "もっと勇気があったら、たぶん冒すと思う。", en: "If I were braver, I probably would." } },
      { id: "e13", speaker: { ja: "みほ", en: "Miho" }, translations: { ja: "べつの みちを そうぞうするのは おもしろいね。", jaKanji: "別の道を想像するのは面白いね。", en: "It's interesting to imagine an alternative path." } },
      { id: "e14", speaker: { ja: "けん", en: "Ken" }, translations: { ja: "うん、もし ちがう ことに なっていたら、どう なっていたか わからないね。", jaKanji: "うん、もし違う事になっていたら、どうなっていたか分からないね。", en: "Yeah, if things had gone differently, who knows what would have happened." } }
    ]
  },
  grammar: {
    ja: {
